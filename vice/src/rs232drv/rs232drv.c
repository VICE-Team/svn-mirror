...
static const cmdline_option_t cmdline_options[] = {
    { "-rsdev1", SET_RESOURCE, 1,
      ...
      IDGS_UNUSED, IDCLS_SPECIFY_RS232_1_NAME,
      "<Name>", NULL },
    { "-rsdev2", SET_RESOURCE, 1,
      NULL, NULL, "RsDevice2", NULL,
      USE_PARAM_STRING, USE_DESCRIPTION_ID,
      IDGS_UNUSED, IDCLS_SPECIFY_RS232_2_NAME,
      "<Name>", NULL },
    { "-rsdev3", SET_RESOURCE, 1,
      NULL, NULL, "RsDevice3", NULL,
      USE_PARAM_STRING, USE_DESCRIPTION_ID,
      IDGS_UNUSED, IDCLS_SPECIFY_RS232_3_NAME,
      "<Name>", NULL },
    { "-rsdev4", SET_RESOURCE, 1,
      NULL, NULL, "RsDevice4", NULL,
      USE_PARAM_STRING, USE_DESCRIPTION_ID,
      IDGS_UNUSED, IDCLS_SPECIFY_RS232_4_NAME,
      "<Name>", NULL },
    CMDLINE_LIST_END
};

...
// (voice muting).
// ----------------------------------------------------------------------------
void RESID::set_voice_mask(reg4 mask)
{
...
// ----------------------------------------------------------------------------
RESID_INLINE
int RESID::clock_resample(cycle_count& delta_t, short* buf, int n,
			int interleave)
{
  int s = 0;
...
// ----------------------------------------------------------------------------
RESID_INLINE
int RESID::clock_resample_fastmem(cycle_count& delta_t, short* buf, int n,
				int interleave)
{
  int s = 0;

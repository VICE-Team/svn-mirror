...
//__android_log_print(ANDROID_LOG_INFO, LOCNET_LOG_TAG, "nativeKey : %d %d", keyCode, unicode);
	...
	if (event.keycode == KEYBOARD_NONE) {
		...
		switch (keyCode) {
			...
			case AKEYCODE_ALT_LEFT: dosboxKeycode = KBD_cbm; break;
			case AKEYCODE_SHIFT_LEFT: dosboxKeycode = KBD_leftshift; break;

			//case AKEYCODE_INSERT:		dosboxKeycode = KBD_insert;	break;
			case AKEYCODE_INSERT:		dosboxKeycode = KBD_pound;	break;
			case AKEYCODE_HOME:		dosboxKeycode = KBD_home;	break;
			//case AKEYCODE_FORWARD_DEL:		dosboxKeycode = KBD_delete;	break;
			case AKEYCODE_FORWARD_DEL:		dosboxKeycode = KBD_up_arrow;	break;
			//case AKEYCODE_END:		dosboxKeycode = KBD_end;	break;
			case AKEYCODE_END:		dosboxKeycode = KBD_at;	break;

			case AKEYCODE_AT:		dosboxKeycode = KBD_at;	break;
			case AKEYCODE_POUND:	dosboxKeycode = KBD_pound;	break;
			case AKEYCODE_STAR:		dosboxKeycode = KBD_star; break;
			case AKEYCODE_PLUS:		dosboxKeycode = KBD_plus; break;

			case AKEYCODE_ESCAPE:	dosboxKeycode = KBD_esc;			break;
			//case AKEYCODE_TAB:		dosboxKeycode = KBD_tab;			break;
			case AKEYCODE_TAB:		dosboxKeycode = KBD_cbm;			break;
			...
			case AKEYCODE_GRAVE:	dosboxKeycode = KBD_left_arrow;			break;
			case AKEYCODE_MINUS:	dosboxKeycode = KBD_plus;			break;
			case AKEYCODE_EQUALS:	dosboxKeycode = KBD_minus;			break;
			//case AKEYCODE_BACKSLASH:	dosboxKeycode = KBD_backslash;			break;
			//case AKEYCODE_BACKSLASH:	dosboxKeycode = KBD_equals;			break;
			case AKEYCODE_BACKSLASH:	dosboxKeycode = KBD_colon;			break;
			//case AKEYCODE_LEFT_BRACKET:	dosboxKeycode = KBD_leftbracket;			break;
			case AKEYCODE_LEFT_BRACKET:	dosboxKeycode = KBD_at;			break;
			//case AKEYCODE_RIGHT_BRACKET:	dosboxKeycode = KBD_rightbracket;			break;
			case AKEYCODE_RIGHT_BRACKET:	dosboxKeycode = KBD_star;			break;
			case AKEYCODE_SEMICOLON:	dosboxKeycode = KBD_colon;			break;
			//case AKEYCODE_APOSTROPHE:	dosboxKeycode = KBD_quote;			break;
			case AKEYCODE_APOSTROPHE:	dosboxKeycode = KBD_semicolon;			break;
			...
			case AKEYCODE_PAGE_UP:		dosboxKeycode = KBD_restore; 	break;
			//case AKEYCODE_PAGE_DOWN:	dosboxKeycode = KBD_pagedown; 	break;
			case AKEYCODE_PAGE_DOWN:	dosboxKeycode = KBD_star; 	break;
...
extern "C" void Android_AudioWriteBuffer()
{
	...
	if ((loadf != 0) && (loadf->abort == 0) && (gEnv != 0)) {
		...
		if ((mixerCallBack != 0) && (loadf->audioBuffer != 0)) {
			...
			//__android_log_print(ANDROID_LOG_INFO, LOCNET_LOG_TAG, "Android_AudioWriteBuffer: %d, %d", len, size);
			//}
...
void getKeyFromUnicode(int unicode, struct locnet_al_event *event)
{
	...
	switch (unicode){
		...
		case '0': dosboxKeycode = KBD_0; break;
		...
		case 0x09: dosboxKeycode = KBD_cbm; break;
		case 0x20: dosboxKeycode = KBD_space; break;
		case 0x0A: dosboxKeycode = KBD_enter; break;
		case '+': dosboxKeycode = KBD_plus; break;
		case '-': dosboxKeycode = KBD_minus; break;
		case '@': dosboxKeycode = KBD_at; break;
		case '*': dosboxKeycode = KBD_star; break;
		case '[': case ':': dosboxKeycode = KBD_colon; break;
		case ']': case ';': dosboxKeycode = KBD_semicolon; break;
		case '=': dosboxKeycode = KBD_equals; break;
		case '?': case '/': dosboxKeycode = KBD_slash; break;
		case '<': case ',': dosboxKeycode = KBD_comma; break;
		case '>': case '.': dosboxKeycode = KBD_period; break;
		case '\\': dosboxKeycode = KBD_colon; break;
		...
		default: dosboxKeycode = KEYBOARD_NONE; break;
	}
	event->keycode = dosboxKeycode;
}

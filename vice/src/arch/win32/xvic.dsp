...
"resvic20cat.rc" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy /b resvic20.rc + res.rc + resdrivevic20.rc + resrs232user.rc + resmidi.rc + reslightpen.rc + resautostart.rc + ressidcart.rc + resacia.rc + resgeoram.rc + resdigimax.rc + restfe.rc + ressoundexpander.rc + ressoundsampler.rc resvic20cat.rc /b

...
USERDEP__RESVI="..\..\debug.h"	"resvic20.rc"	"res.rc"	"resdrivevic20.rc"	"resrs232user.rc"	"ressidcart.rc"	"reslightpen.rc"	"resautostart.rc"	"resmidi.rc"	"resacia.rc"

# Begin Custom Build
InputPath=.\resvic20.rc

"resvic20cat.rc" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy /b resvic20.rc + res.rc + resdrivevic20.rc + resrs232user.rc + resmidi.rc + reslightpen.rc + resautostart.rc + ressidcart.rc + resacia.rc resvic20cat.rc /b

...
BEGIN
    ...
    CTEXT    "Release " VERSION ,IDC_STATIC,7,31,118,8
    ...
    CTEXT    "Copyright (c) 1998-1999 Andreas Boose",IDC_STATIC,16,86,158,8
...
IDD_DRIVE_SETTINGS_DIALOG DIALOG DISCARDABLE  0, 0, 250, 135
STYLE DS_MODALFRAME | WS_POPUP | WS_CAPTION | WS_SYSMENU
FONT 8, "MS Sans Serif"
BEGIN
    GROUPBOX        "&Drive type",IDC_STATIC,5,15,60,105
    ...
    AUTORADIOBUTTON "1541-II",IDC_SELECT_DRIVE_TYPE_1541II,15,45,35,10,
                            BS_AUTORADIOBUTTON
    AUTORADIOBUTTON "1571",IDC_SELECT_DRIVE_TYPE_1571,15,60,35,10,
                            BS_AUTORADIOBUTTON
    AUTORADIOBUTTON "1581",IDC_SELECT_DRIVE_TYPE_1581,15,75,35,10,
                            BS_AUTORADIOBUTTON
    AUTORADIOBUTTON "2031",IDC_SELECT_DRIVE_TYPE_2031,15,90,35,10,
                            BS_AUTORADIOBUTTON
    AUTORADIOBUTTON "None",IDC_SELECT_DRIVE_TYPE_NONE,15,105,35,10,
                            BS_AUTORADIOBUTTON

...
USERDEP__RESCB="..\..\debug.h"	"rescbm5x0.rc"	"rescbm2common.rc" "res.rc"	"resacia.rc"	"resdrivepetcbm2.rc"	"ressid.rc"	"resautostart.rc"	"resvicii.rc"	
# Begin Custom Build
InputPath=.\rescbm5x0.rc

"rescbm5x0cat.rc" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy /b rescbm5x0.rc + rescbm2common.rc + res.rc + resacia.rc + resdrivepetcbm2.rc + ressid.rc + resautostart.rc + resvicii.rc rescbm5x0cat.rc /b

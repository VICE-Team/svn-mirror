...
USERDEP__RESPE="..\..\debug.h"	"respet.rc"	"res.rc"	"resacia.rc"	"resdrivepetcbm2.rc"	"respetreu.rc"	"resautostart.rc"	"ressidcart.rc"	
# Begin Custom Build
InputPath=.\respet.rc

"respetcat.rc" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy /b respet.rc + res.rc + resacia.rc + resdrivepetcbm2.rc + respetreu.rc + resautostart.rc + ressidcart.rc respetcat.rc  /b

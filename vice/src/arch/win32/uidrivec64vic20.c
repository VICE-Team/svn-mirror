/*
 * uidrivec64vic20.c - Implementation of the drive settings dialog box.
 *
 * Written by
...
void uidrivec64vic20_settings_dialog(HWND hwnd)
{
    PROPSHEETPAGE psp[4];
    PROPSHEETHEADER psh;
    int i;
    ...
    for (i = 0; i < 4; i++) {
        ...
        psp[i].pszTemplate
            = MAKEINTRESOURCE(intl_translate(IDD_DRIVE_SETTINGS_DIALOG_C64VIC20));
        psp[i].pszIcon = NULL;
#else

...
# ADD CPP /nologo /MT /W3 /GX /O2 /I ".\msvc" /I ".\\" /I "..\\" /I "..\..\\" /I "..\..\drive" /I "..\..\vdrive" /I "..\..\monitor" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /YX /FD /c
...
# ADD CPP /nologo /MTd /W3 /GX /Z7 /Od /I ".\msvc" /I ".\\" /I "..\\" /I "..\..\\" /I "..\..\drive" /I "..\..\vdrive" /I "..\..\monitor" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /YX /FD /c
...
USERDEP__RESC1="..\..\debug.h"	"resc128.rc"	"res.rc"	"resacia.rc"	"reside64.rc"	"resreu.rc"	"resgeoram.rc"	"resramcart.rc"	"resmmc64.rc"	"resmmcreplay.rc"	"resrs232user.rc"	"ressid.rc"	"resvicii.rc"	"resdrivec128.rc"	"resdigimax.rc"	"resmouse.rc"	"resmidi.rc"	"reslightpen.rc"	"ressoundexpander.rc"	"reseasyflash.rc"	"resautostart.rc"	"restfe.rc"	
# Begin Custom Build
InputPath=.\resc128.rc

"resc128cat.rc" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy /b resc128.rc + res.rc + resacia.rc + reside64.rc + resreu.rc + resgeoram.rc + resramcart.rc + resmmc64.rc + resmmcreplay.rc + resrs232user.rc + ressid.rc + resvicii.rc + resdrivec128.rc + resdigimax.rc + resmouse.rc + resmidi.rc + reslightpen.rc + ressoundexpander.rc + reseasyflash.rc + resautostart.rc + restfe.rc resc128cat.rc /b
...
# PROP Ignore_Default_Tool 1
USERDEP__RESC1="..\..\debug.h"	"resc128.rc"	"res.rc"	"resacia.rc"	"reside64.rc"	"resreu.rc"	"resgeoram.rc"	"resramcart.rc"	"resmmc64.rc"	"resmmcreplay.rc"	"resrs232user.rc"	"ressid.rc"	"resvicii.rc"	"resdrivec128.rc"	"resdigimax.rc"	"resmouse.rc"	"resmidi.rc"	"reslightpen.rc"	"resautostart.rc"	"ressoundexpander.rc"	"reseasyflash.rc"	"restfe.rc"	
# Begin Custom Build
InputPath=.\resc128.rc

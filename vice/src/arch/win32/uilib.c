...
static uilib_filefilter_t uilib_filefilter[] = {
    ...
    /* 0040 */ { IDS_DISK_IMAGE_FILES_FILTER, TEXT("*.d64;*.d67;*.d71;*.d80;*.d81;*.d82;*.d1m;*.d2m;*.d4m;*.g64;;*.g71;*.g41;*.p64;*.x64") },
    /* 0080 */ { IDS_CBM_IMAGE_FILES_FILTER, TEXT("*.d64;*.d67;*.d71;*.d80;*.d81;*.d82;*.d1m;*.d2m;*.d4m;*.g64;*.g71;*.g41;*.p64;*.x64;*.t64;*.tap;*.prg;*.p00") },

...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib comdlg32.lib shell32.lib version.lib /nologo /subsystem:console /machine:I386
...
# ADD CPP /nologo /W3 /GX /Z7 /Od /I "msvc" /I ".\\" /I "..\\" /I "..\..\\" /I "..\..\drive" /I "..\..\vdrive" /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /YX /FD /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib comdlg32.lib shell32.lib version.lib /nologo /subsystem:console /debug /machine:I386 /pdbtype:sept

...
static const uirom_settings_t uirom_settings[] = {
    ...
    { UIROM_TYPE_MAIN, TEXT("International Charcater"), "ChargenIntName",
      IDC_C128ROM_CHARGENINT_FILE, IDC_C128ROM_CHARGENINT_BROWSE },
    { UIROM_TYPE_MAIN, TEXT("German Charcater"), "ChargenDEName",
      IDC_C128ROM_CHARGENDE_FILE, IDC_C128ROM_CHARGENDE_BROWSE },
    { UIROM_TYPE_MAIN, TEXT("French Charcater"), "ChargenFRName",
      IDC_C128ROM_CHARGENFR_FILE, IDC_C128ROM_CHARGENFR_BROWSE },
    { UIROM_TYPE_MAIN, TEXT("Swedish Charcater"), "ChargenSEName",
    ...
    switch (wparam) {
      ...
      case IDM_ROM_SETTINGS:
        uirom_settings_dialog(hwnd, IDD_C128ROM_SETTINGS_DIALOG,
                              IDD_C128DRIVEROM_SETTINGS_DIALOG, uirom_settings);
        break;
#ifdef HAVE_TFE

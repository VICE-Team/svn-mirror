/*
 * keyboardsettingswindowcontroller.h - KeyboardSettings dialog controller
 *
 * Written by
...
@interface KeyboardSettingsWindowController : VICEResourceWindowController
{
    IBOutlet NSMatrix *keymapSelector;

...
if [ ! -e /usr/local/bin/x64 -o ! -e /usr/local/bin/x64dtv -o ! -e /usr/local/bin/x64sc -o ! -e /usr/local/bin/x128 -o ! -e /usr/local/bin/xvic -o ! -e /usr/local/bin/xpet -o ! -e /usr/local/bin/xplus4 -o ! -e /usr/local/bin/xcbm2 -o ! -e /usr/local/bin/c1541 -o ! -e /usr/local/bin/petcat -o ! -e /usr/local/bin/cartconv ]
then
...
tar cf vice-$VICEVERSION-qnx4.tar install_msg /usr/local/bin/vsid /usr/local/bin/x64 /usr/local/bin/x64dtv /usr/local/bin/x64sc /usr/local/bin/x128 /usr/local/bin/xvic /usr/local/bin/xpet /usr/local/bin/xplus4 /usr/local/bin/xcbm2 /usr/local/bin/c1541 /usr/local/bin/petcat /usr/local/bin/cartconv /usr/local/lib/vice /usr/local/man/man1/c1541.1 /usr/local/man/man1/petcat.1 /usr/local/man/man1/vice.1 /usr/local/info/vice.info*

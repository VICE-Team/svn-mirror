...
{
    uilib_select_file((char *)UI_MENU_CB_PARAM, _("Magic Voice file"), UILIB_FILTER_ALL);
}
...
ui_menu_entry_t magicvoice_submenu[] = {
    ...
    { N_("Image name"), UI_MENU_TYPE_DOTS,
      (ui_callback_t)set_magicvoice_image_name, (ui_callback_data_t)"MagicVoiceImage", NULL,
      (ui_keysym_t)0, (ui_hotkey_modifier_t)0 },

...
#
# make-bindist.sh - make binary distribution for the HPUX port
#
# Written by
...
#  02111-1307  USA.
#
# Usage: make-bindist.sh <strip> <perl> <vice-version> <prefix> <hostcpu> <system> <--enable-arch> <zip|nozip> <x64sc-included> <topsrcdir>

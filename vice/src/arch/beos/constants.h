...
const uint32 MENU_AUYOSTART_PRG_VIRTUAL_FS        = 'M196';
const uint32 MENU_AUYOSTART_PRG_INJECT            = 'M197';
const uint32 MENU_AUYOSTART_PRG_DISK_IMAGE        = 'M198';
const uint32 MENU_AUYOSTART_PRG_DISK_IMAGE_SELECT = 'M199';

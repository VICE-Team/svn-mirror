...
VideoWindow::VideoWindow() 
	: BWindow(BRect(250,50,500,250),"Video settings",
		B_TITLED_WINDOW, 
		B_NOT_ZOOMABLE | B_NOT_RESIZABLE) 
{
	...
	palettelistview = new BListView(BRect(110, 40, 220, 150), "Palette File");

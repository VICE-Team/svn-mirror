		...
		switch (message_queue[i].what) {
			...
			case MENU_ABOUT:
				...
				abouttext = util_concat(
					...
					"(c) 1999-2009 Andreas Matthies\n",
					"(c) 1999-2009 Martin Pottendorfer\n",
					"(c) 2000-2009 Spiro Trikaliotis\n",
					"(c) 2005-2009 Marco van den Heuvel\n",
					"(c) 2006-2009 Christian Vogelgsang\n",
					"(c) 2007-2009 Fabrizio Gennari\n",

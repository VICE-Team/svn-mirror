		...
		switch (message_queue[i].what) {
			...
			case MENU_ABOUT:
				...
				abouttext = util_concat(
					...
					"(c) 1998-2005 Andreas Boose\n",
					"(c) 1998-2005 Dag Lem\n",
					"(c) 1998-2005 Tibor Biczo\n",
					"(c) 1999-2005 Andreas Dehmel\n",
					"(c) 1999-2005 Thomas Bretz\n",
					"(c) 1999-2005 Andreas Matthies\n",
					"(c) 1999-2005 Martin Pottendorfer\n",
					"(c) 2000-2005 Spiro Trikaliotis\n",
					"(c) 2003-2005 David Hansel\n",
					"(c) 2000-2004 Markus Brenner\n",
					"(c) 2005      Marco van den Heuvel\n",

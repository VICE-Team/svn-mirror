		...
		switch (message_queue[i].what) {
			...
			case MENU_ABOUT:
				...
				abouttext = util_concat(
					...
					"(c) 1998-2006 Andreas Boose\n",
					"(c) 1998-2006 Dag Lem\n",
					"(c) 1998-2006 Tibor Biczo\n",
					"(c) 1999-2006 Andreas Dehmel\n",
					"(c) 1999-2006 Andreas Matthies\n",
					"(c) 1999-2006 Martin Pottendorfer\n",
					"(c) 2000-2006 Spiro Trikaliotis\n",
                                        "(c) 2005-2006 Marco van den Heuvel\n",

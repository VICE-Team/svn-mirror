...
static const ui_action_info_private_t action_info_list[] = {
    ...
    { ACTION_PSID_SUBTUNE_1,            "psid-subtune-1",           "Select subtune #1",        VICE_MACHINE_VSID },
    { ACTION_PSID_SUBTUNE_2,            "psid-subtune-2",           "Select subtune #2",        VICE_MACHINE_VSID },
    { ACTION_PSID_SUBTUNE_3,            "psid-subtune-3",           "Select subtune #3",        VICE_MACHINE_VSID },
    { ACTION_PSID_SUBTUNE_4,            "psid-subtune-4",           "Select subtune #4",        VICE_MACHINE_VSID },
    { ACTION_PSID_SUBTUNE_5,            "psid-subtune-5",           "Select subtune #5",        VICE_MACHINE_VSID },
    { ACTION_PSID_SUBTUNE_6,            "psid-subtune-6",           "Select subtune #6",        VICE_MACHINE_VSID },
    { ACTION_PSID_SUBTUNE_7,            "psid-subtune-7",           "Select subtune #7",        VICE_MACHINE_VSID },
    { ACTION_PSID_SUBTUNE_8,            "psid-subtune-8",           "Select subtune #8",        VICE_MACHINE_VSID },
    { ACTION_PSID_SUBTUNE_9,            "psid-subtune-9",           "Select subtune #9",        VICE_MACHINE_VSID },
    { ACTION_PSID_SUBTUNE_10,           "psid-subtune-10",          "Select subtune #10",       VICE_MACHINE_VSID },
    { ACTION_PSID_SUBTUNE_11,           "psid-subtune-11",          "Select subtune #11",       VICE_MACHINE_VSID },
    { ACTION_PSID_SUBTUNE_12,           "psid-subtune-12",          "Select subtune #12",       VICE_MACHINE_VSID },
    { ACTION_PSID_SUBTUNE_13,           "psid-subtune-13",          "Select subtune #13",       VICE_MACHINE_VSID },
    { ACTION_PSID_SUBTUNE_14,           "psid-subtune-14",          "Select subtune #14",       VICE_MACHINE_VSID },
    { ACTION_PSID_SUBTUNE_15,           "psid-subtune-15",          "Select subtune #15",       VICE_MACHINE_VSID },
    { ACTION_PSID_SUBTUNE_16,           "psid-subtune-16",          "Select subtune #16",       VICE_MACHINE_VSID },
    { ACTION_PSID_SUBTUNE_17,           "psid-subtune-17",          "Select subtune #17",       VICE_MACHINE_VSID },
    { ACTION_PSID_SUBTUNE_18,           "psid-subtune-18",          "Select subtune #18",       VICE_MACHINE_VSID },
    { ACTION_PSID_SUBTUNE_19,           "psid-subtune-19",          "Select subtune #19",       VICE_MACHINE_VSID },
    { ACTION_PSID_SUBTUNE_20,           "psid-subtune-20",          "Select subtune #20",       VICE_MACHINE_VSID },
    { ACTION_PSID_SUBTUNE_21,           "psid-subtune-21",          "Select subtune #21",       VICE_MACHINE_VSID },
    { ACTION_PSID_SUBTUNE_22,           "psid-subtune-22",          "Select subtune #22",       VICE_MACHINE_VSID },
    { ACTION_PSID_SUBTUNE_23,           "psid-subtune-23",          "Select subtune #23",       VICE_MACHINE_VSID },
    { ACTION_PSID_SUBTUNE_24,           "psid-subtune-24",          "Select subtune #24",       VICE_MACHINE_VSID },
    { ACTION_PSID_SUBTUNE_25,           "psid-subtune-25",          "Select subtune #25",       VICE_MACHINE_VSID },
    { ACTION_PSID_SUBTUNE_26,           "psid-subtune-26",          "Select subtune #26",       VICE_MACHINE_VSID },
    { ACTION_PSID_SUBTUNE_27,           "psid-subtune-27",          "Select subtune #27",       VICE_MACHINE_VSID },
    { ACTION_PSID_SUBTUNE_28,           "psid-subtune-28",          "Select subtune #28",       VICE_MACHINE_VSID },
    { ACTION_PSID_SUBTUNE_29,           "psid-subtune-29",          "Select subtune #29",       VICE_MACHINE_VSID },
    { ACTION_PSID_SUBTUNE_30,           "psid-subtune-30",          "Select subtune #30",       VICE_MACHINE_VSID },

    { ACTION_PSID_SUBTUNE_NEXT,         "psid-subtune-next",        "Select next subtune",      VICE_MACHINE_VSID },

...
#define ACTION_SWAP_USERPORT_TOGGLE         "swap-userport-toggle"
#define ACTION_SWAP_USERPORT_TOGGLE_DESC    "Swap userport joysticks"
#define ACTION_SWAP_USERPORT_TOGGLE_MASK    (VICE_MACHINE_C64|VICE_MACHINE_C64SC|VICE_MACHINE_SCPU64|VICE_MACHINE_C128|VICE_MACHINE_VIC20|VICE_MACHINE_PLUS4|VICE_MACHINE_PET|VICE_MACHINE_CBM6x0)

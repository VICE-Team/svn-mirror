 ...
 */
void
novte_terminal_copy_clipboard(NoVteTerminal *terminal)
{
 ...
 */
void
vte_terminal_copy_clipboard_format(NoVteTerminal *terminal,
                                   VteFormat format)
{
        g_return_if_fail(VTE_IS_TERMINAL(terminal));
 ...
 */
void
vte_terminal_copy_primary(NoVteTerminal *terminal)
{
    g_return_if_fail(VTE_IS_TERMINAL(terminal));
 ...
 */
void
vte_terminal_paste_clipboard(NoVteTerminal *terminal)
{
    g_return_if_fail(VTE_IS_TERMINAL(terminal));
 ...
 */
void
vte_terminal_paste_primary(NoVteTerminal *terminal)
{
    g_return_if_fail(VTE_IS_TERMINAL(terminal));
 ...
 */
int
vte_terminal_match_add_gregex(NoVteTerminal *terminal,
                              GRegex *gregex,
 ...
 */
int
vte_terminal_match_add_regex(NoVteTerminal *terminal,
                             VteRegex    *regex,
                             guint32      flags)
{
 ...
 */
char *
vte_terminal_match_check(NoVteTerminal *terminal,
                         long column,
                         long row,
             int *tag)
{
 ...
 */
char *
vte_terminal_match_check_event(NoVteTerminal *terminal,
                               GdkEvent *event,
                               int *tag)
{
 ...
 */
char *
vte_terminal_hyperlink_check_event(NoVteTerminal *terminal,
                                   GdkEvent *event)
{
        g_return_val_if_fail(VTE_IS_TERMINAL(terminal), FALSE);
 ...
 */
gboolean
vte_terminal_event_check_regex_simple(NoVteTerminal *terminal,
                                      GdkEvent *event,
                                      VteRegex **regexes,
                                      gsize n_regexes,
                                      guint32 match_flags,
 ...
 */
gboolean
vte_terminal_event_check_gregex_simple(NoVteTerminal *terminal,
                                       GdkEvent *event,
                                       GRegex **regexes,
                                       gsize n_regexes,
 ...
 */
void
vte_terminal_match_set_cursor(NoVteTerminal *terminal,
                              int tag,
                              GdkCursor *cursor)
{
    g_return_if_fail(VTE_IS_TERMINAL(terminal));
 ...
 */
void
vte_terminal_match_set_cursor_type(NoVteTerminal *terminal,
                   int tag,
 ...
 */
void
vte_terminal_match_set_cursor_name(NoVteTerminal *terminal,
                   int tag,
 ...
 */
void
vte_terminal_match_remove(NoVteTerminal *terminal, int tag)
{
    g_return_if_fail(VTE_IS_TERMINAL(terminal));
 ...
 */
void
vte_terminal_match_remove_all(NoVteTerminal *terminal)
{
    g_return_if_fail(VTE_IS_TERMINAL(terminal));
 ...
 */
gboolean
vte_terminal_search_find_previous (NoVteTerminal *terminal)
{
        g_return_val_if_fail(VTE_IS_TERMINAL(terminal), FALSE);
 ...
 */
gboolean
vte_terminal_search_find_next (NoVteTerminal *terminal)
{
        g_return_val_if_fail(VTE_IS_TERMINAL(terminal), FALSE);
 ...
 */
void
vte_terminal_search_set_regex (NoVteTerminal *terminal,
                               VteRegex    *regex,
                               guint32      flags)
{
        g_return_if_fail(VTE_IS_TERMINAL(terminal));
 ...
 */
VteRegex *
vte_terminal_search_get_regex(NoVteTerminal *terminal)
{
    g_return_val_if_fail(VTE_IS_TERMINAL(terminal), NULL);
 ...
 */
void
vte_terminal_search_set_gregex (NoVteTerminal *terminal,
                GRegex      *gregex,
                                GRegexMatchFlags gflags)
{
 ...
 */
GRegex *
vte_terminal_search_get_gregex (NoVteTerminal *terminal)
{
    g_return_val_if_fail(VTE_IS_TERMINAL(terminal), NULL);
 ...
 */
void
vte_terminal_search_set_wrap_around (NoVteTerminal *terminal,
 ...
 */
gboolean
vte_terminal_search_get_wrap_around (NoVteTerminal *terminal)
{
    g_return_val_if_fail(VTE_IS_TERMINAL(terminal), FALSE);
 ...
 */
void
vte_terminal_select_all (NoVteTerminal *terminal)
{
    g_return_if_fail (VTE_IS_TERMINAL (terminal));
 ...
 */
void
vte_terminal_unselect_all(NoVteTerminal *terminal)
{
    g_return_if_fail (VTE_IS_TERMINAL (terminal));
 ...
 */
void
vte_terminal_get_cursor_position(NoVteTerminal *terminal,
                 long *column,
                                 long *row)
{
    g_return_if_fail(VTE_IS_TERMINAL(terminal));
 ...
 */
VtePty *
vte_terminal_pty_new_sync(NoVteTerminal *terminal,
                          VtePtyFlags flags,
 ...
 * @child_pid: a #GPid
 *
 * Watches @child_pid. When the process exists, the #NoVteTerminal::child-exited
 ...
 */
void
vte_terminal_watch_child (NoVteTerminal *terminal,
                          GPid child_pid)
{
        g_return_if_fail(VTE_IS_TERMINAL(terminal));
 ...
 */
gboolean
vte_terminal_spawn_sync(NoVteTerminal *terminal,
...
static gpointer
spawn_async_callback_data_new(NoVteTerminal *terminal,
                     VteTerminalSpawnAsyncCallback callback,
                     gpointer user_data)
{
                ...
                gpointer user_data)
{
        ...
        NoVteTerminal* terminal = (NoVteTerminal*)g_weak_ref_get(&data->wref);
 ...
 * but taking care not to access the now-destroyed #NoVteTerminal. Note that
 ...
 */
void
vte_terminal_spawn_async(NoVteTerminal *terminal,
                         VtePtyFlags pty_flags,
                         const char *working_directory,
                         char **argv,
                         char **envv,
 ...
 */
void
novte_terminal_feed(NoVteTerminal *terminal,
                  const char *data,
                  gssize length)
{
        g_return_if_fail(VTE_IS_TERMINAL(terminal));
 ...
 */
void
vte_terminal_feed_child(NoVteTerminal *terminal,
                        const char *text,
                        gssize length)
{
        g_return_if_fail(VTE_IS_TERMINAL(terminal));
 ...
 */
void
vte_terminal_feed_child_binary(NoVteTerminal *terminal,
                               const guint8 *data,
                               gsize length)
{
        g_return_if_fail(VTE_IS_TERMINAL(terminal));
 ...
 */
char *
vte_terminal_get_text(NoVteTerminal *terminal,
 ...
 */
char *
vte_terminal_get_text_include_trailing_spaces(NoVteTerminal *terminal,
                          VteSelectionFunc is_selected,
                          gpointer user_data,
                          GArray *attributes)
{
 ...
 */
char *
vte_terminal_get_text_range(NoVteTerminal *terminal,
                long start_row,
                            long start_col,
                long end_row,
                            long end_col,
 ...
 */
void
vte_terminal_reset(NoVteTerminal *terminal,
 ...
 */
void
vte_terminal_set_size(NoVteTerminal *terminal,
                      long columns,
                      long rows)
{
 ...
 */
VteTextBlinkMode
vte_terminal_get_text_blink_mode(NoVteTerminal *terminal)
{
 ...
 */
void
vte_terminal_set_text_blink_mode(NoVteTerminal *terminal,
 ...
 */
gboolean
vte_terminal_get_allow_bold(NoVteTerminal *terminal)
{
    g_return_val_if_fail(VTE_IS_TERMINAL(terminal), FALSE);
 ...
 */
void
vte_terminal_set_allow_bold(NoVteTerminal *terminal,
                            gboolean allow_bold)
{
        g_return_if_fail(VTE_IS_TERMINAL(terminal));
 ...
 */
gboolean
vte_terminal_get_allow_hyperlink(NoVteTerminal *terminal)
{
        g_return_val_if_fail(VTE_IS_TERMINAL(terminal), FALSE);
 ...
 */
void
vte_terminal_set_allow_hyperlink(NoVteTerminal *terminal,
 ...
 */
gboolean
vte_terminal_get_audible_bell(NoVteTerminal *terminal)
{
    g_return_val_if_fail(VTE_IS_TERMINAL(terminal), FALSE);
 ...
 */
void
vte_terminal_set_audible_bell(NoVteTerminal *terminal,
                              gboolean is_audible)
{
        g_return_if_fail(VTE_IS_TERMINAL(terminal));
 ...
 */
gboolean
vte_terminal_get_bold_is_bright(NoVteTerminal *terminal)
{
    g_return_val_if_fail(VTE_IS_TERMINAL(terminal), FALSE);
 ...
 */
void
vte_terminal_set_bold_is_bright(NoVteTerminal *terminal,
 ...
 */
glong
novte_terminal_get_char_height(NoVteTerminal *terminal)
{
    g_return_val_if_fail(VTE_IS_TERMINAL(terminal), -1);
 ...
 */
glong
novte_terminal_get_char_width(NoVteTerminal *terminal)
{
    g_return_val_if_fail(VTE_IS_TERMINAL(terminal), -1);
 ...
 */
int
vte_terminal_get_cjk_ambiguous_width(NoVteTerminal *terminal)
{
        g_return_val_if_fail(VTE_IS_TERMINAL(terminal), 1);
 ...
 */
void
vte_terminal_set_cjk_ambiguous_width(NoVteTerminal *terminal, int width)
{
        g_return_if_fail(VTE_IS_TERMINAL(terminal));
 ...
 */
void
vte_terminal_set_color_background(NoVteTerminal *terminal,
 ...
 */
void
vte_terminal_set_color_bold(NoVteTerminal *terminal,
                            const GdkRGBA *bold)
{
        g_return_if_fail(VTE_IS_TERMINAL(terminal));
 ...
 */
void
vte_terminal_set_color_cursor(NoVteTerminal *terminal,
 ...
 */
void
vte_terminal_set_color_cursor_foreground(NoVteTerminal *terminal,
 ...
 */
void
vte_terminal_set_color_foreground(NoVteTerminal *terminal,
 ...
 */
void
vte_terminal_set_color_highlight(NoVteTerminal *terminal,
 ...
 */
void
vte_terminal_set_color_highlight_foreground(NoVteTerminal *terminal,
 ...
 */
void
vte_terminal_set_colors(NoVteTerminal *terminal,
                        const GdkRGBA *foreground,
                        const GdkRGBA *background,
 ...
 */
void
vte_terminal_set_default_colors(NoVteTerminal *terminal)
{
    g_return_if_fail(VTE_IS_TERMINAL(terminal));
 ...
 */
glong
novte_terminal_get_column_count(NoVteTerminal *terminal)
{
    g_return_val_if_fail(VTE_IS_TERMINAL(terminal), -1);
 ...
 */
const char *
vte_terminal_get_current_directory_uri(NoVteTerminal *terminal)
{
        g_return_val_if_fail(VTE_IS_TERMINAL(terminal), NULL);
 ...
 */
const char *
vte_terminal_get_current_file_uri(NoVteTerminal *terminal)
{
        g_return_val_if_fail(VTE_IS_TERMINAL(terminal), NULL);
 ...
 */
VteCursorBlinkMode
vte_terminal_get_cursor_blink_mode(NoVteTerminal *terminal)
{
 ...
 */
void
vte_terminal_set_cursor_blink_mode(NoVteTerminal *terminal,
 ...
 */
VteCursorShape
vte_terminal_get_cursor_shape(NoVteTerminal *terminal)
{
 ...
 */
void
vte_terminal_set_cursor_shape(NoVteTerminal *terminal, VteCursorShape shape)
{
    g_return_if_fail(VTE_IS_TERMINAL(terminal));
 ...
 */
const char *
vte_terminal_get_encoding(NoVteTerminal *terminal)
{
    g_return_val_if_fail(VTE_IS_TERMINAL(terminal), NULL);
 ...
 */
gboolean
vte_terminal_set_encoding(NoVteTerminal *terminal,
                          const char *codeset,
                          GError **error)
{
    g_return_val_if_fail(VTE_IS_TERMINAL(terminal), FALSE);
...
vte_terminal_get_font(NoVteTerminal *terminal)
{
        g_return_val_if_fail(VTE_IS_TERMINAL(terminal), NULL);
 ...
 */
void
vte_terminal_set_font(NoVteTerminal *terminal,
 ...
 */
gdouble
vte_terminal_get_font_scale(NoVteTerminal *terminal)
{
        g_return_val_if_fail(VTE_IS_TERMINAL(terminal), 1.);
 ...
 */
void
vte_terminal_set_font_scale(NoVteTerminal *terminal,
                            double scale)
{
        g_return_if_fail(VTE_IS_TERMINAL(terminal));
 ...
 */
double
vte_terminal_get_cell_height_scale(NoVteTerminal *terminal)
{
        g_return_val_if_fail(VTE_IS_TERMINAL(terminal), 1.);
 ...
 */
void
vte_terminal_set_cell_height_scale(NoVteTerminal *terminal,
                                   double scale)
{
        g_return_if_fail(VTE_IS_TERMINAL(terminal));
 ...
 */
double
vte_terminal_get_cell_width_scale(NoVteTerminal *terminal)
{
        g_return_val_if_fail(VTE_IS_TERMINAL(terminal), 1.);
 ...
 */
void
vte_terminal_set_cell_width_scale(NoVteTerminal *terminal,
                                  double scale)
{
        g_return_if_fail(VTE_IS_TERMINAL(terminal));
 ...
 */
void
vte_terminal_get_geometry_hints(NoVteTerminal *terminal,
                                GdkGeometry *hints,
                                int min_rows,
                                int min_columns)
{
 ...
 */
void
vte_terminal_set_geometry_hints_for_window(NoVteTerminal *terminal,
                                           GtkWindow *window)
{
        GdkGeometry hints;
 ...
 */
gboolean
vte_terminal_get_has_selection(NoVteTerminal *terminal)
{
    g_return_val_if_fail(VTE_IS_TERMINAL(terminal), FALSE);
 ...
 */
const char *
vte_terminal_get_icon_title(NoVteTerminal *terminal)
{
 ...
 */
gboolean
vte_terminal_get_input_enabled (NoVteTerminal *terminal)
{
        g_return_val_if_fail(VTE_IS_TERMINAL(terminal), FALSE);
 ...
 */
void
vte_terminal_set_input_enabled (NoVteTerminal *terminal,
                                gboolean enabled)
{
        g_return_if_fail(VTE_IS_TERMINAL(terminal));
 ...
 */
gboolean
vte_terminal_get_mouse_autohide(NoVteTerminal *terminal)
{
    g_return_val_if_fail(VTE_IS_TERMINAL(terminal), FALSE);
 ...
 */
void
vte_terminal_set_mouse_autohide(NoVteTerminal *terminal, gboolean setting)
{
    g_return_if_fail(VTE_IS_TERMINAL(terminal));
 ...
 */
void
vte_terminal_set_pty(NoVteTerminal *terminal,
                     VtePty *pty)
{
        g_return_if_fail(VTE_IS_TERMINAL(terminal));
 ...
 */
VtePty *
vte_terminal_get_pty(NoVteTerminal *terminal)
{
        g_return_val_if_fail (VTE_IS_TERMINAL (terminal), NULL);
 ...
 */
gboolean
vte_terminal_get_rewrap_on_resize(NoVteTerminal *terminal)
{
    g_return_val_if_fail(VTE_IS_TERMINAL(terminal), FALSE);
 ...
 */
void
vte_terminal_set_rewrap_on_resize(NoVteTerminal *terminal,
                                  gboolean rewrap)
{
        g_return_if_fail(VTE_IS_TERMINAL(terminal));
 ...
 */
glong
novte_terminal_get_row_count(NoVteTerminal *terminal)
{
    g_return_val_if_fail(VTE_IS_TERMINAL(terminal), -1);
 ...
 */
void
novte_terminal_set_scrollback_lines(NoVteTerminal *terminal, glong lines)
{
        g_return_if_fail(VTE_IS_TERMINAL(terminal));
 ...
 */
glong
vte_terminal_get_scrollback_lines(NoVteTerminal *terminal)
{
 ...
 */
void
vte_terminal_set_scroll_on_keystroke(NoVteTerminal *terminal,
                                     gboolean scroll)
{
    g_return_if_fail(VTE_IS_TERMINAL(terminal));
 ...
 */
gboolean
vte_terminal_get_scroll_on_keystroke(NoVteTerminal *terminal)
{
    g_return_val_if_fail(VTE_IS_TERMINAL(terminal), FALSE);
 ...
 */
void
novte_terminal_set_scroll_on_output(NoVteTerminal *terminal,
                                  gboolean scroll)
{
    g_return_if_fail(VTE_IS_TERMINAL(terminal));
 ...
 */
gboolean
vte_terminal_get_scroll_on_output(NoVteTerminal *terminal)
{
    g_return_val_if_fail(VTE_IS_TERMINAL(terminal), FALSE);
 ...
 */
const char *
vte_terminal_get_window_title(NoVteTerminal *terminal)
{
    g_return_val_if_fail(VTE_IS_TERMINAL(terminal), "");
 ...
 */
const char *
vte_terminal_get_word_char_exceptions(NoVteTerminal *terminal)
{
        g_return_val_if_fail(VTE_IS_TERMINAL(terminal), NULL);
 ...
 */
void
vte_terminal_set_word_char_exceptions(NoVteTerminal *terminal,
 ...
 */
gboolean
vte_terminal_write_contents_sync (NoVteTerminal *terminal,
 ...
 */
void
vte_terminal_set_clear_background(NoVteTerminal* terminal,
                                  gboolean setting)
{
        g_return_if_fail(VTE_IS_TERMINAL(terminal));

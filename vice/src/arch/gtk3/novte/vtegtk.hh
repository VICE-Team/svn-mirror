...
/* some options, hardcoded :) */

#define VTE_TYPE_CURSOR_BLINK_MODE  1   /* blinking cursor? */
#define VTE_TYPE_CURSOR_SHAPE       1
#define VTE_TYPE_TEXT_BLINK_MODE    0   /* allow blinking text? */

...
void joystick_update(void)
{
    ...
    if (joystick_port_map[0] == JOYDEV_HW1 ||
        joystick_port_map[1] == JOYDEV_HW1 ||
        joystick_port_map[2] == JOYDEV_HW1 ||
        joystick_port_map[3] == JOYDEV_HW1) {
        int value = 0;
    ...
    if (num_joysticks >= 2
        && (joystick_port_map[0] == JOYDEV_HW2 ||
            ...
            joystick_port_map[2] == JOYDEV_HW2 ||
            joystick_port_map[3] == JOYDEV_HW2)) {
        int value = 0;

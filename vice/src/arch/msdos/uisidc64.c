...
static tui_menu_item_def_t sid_stereo_address_d5xx_submenu[] = {
    { "$D500", "$D500",
      radio_SidStereoAddressStart_callback, (void *)0xd500, 0,
      TUI_MENU_BEH_CLOSE, NULL, NULL },
    { "$D520", "$D520",
      radio_SidStereoAddressStart_callback, (void *)0xd520, 0,
      TUI_MENU_BEH_CLOSE, NULL, NULL },
    { "$D540", "$D540",
      radio_SidStereoAddressStart_callback, (void *)0xd540, 0,
      TUI_MENU_BEH_CLOSE, NULL, NULL },
    { "$D560", "$D560",
      radio_SidStereoAddressStart_callback, (void *)0xd560, 0,
      TUI_MENU_BEH_CLOSE, NULL, NULL },
    { "$D580", "$D580",
      radio_SidStereoAddressStart_callback, (void *)0xd580, 0,
      TUI_MENU_BEH_CLOSE, NULL, NULL },
    { "$D5A0", "$D5A0",
      radio_SidStereoAddressStart_callback, (void *)0xd5a0, 0,
      TUI_MENU_BEH_CLOSE, NULL, NULL },
    { "$D5C0", "$D5C0",
      radio_SidStereoAddressStart_callback, (void *)0xd5c0, 0,
      TUI_MENU_BEH_CLOSE, NULL, NULL },
    { "$D5E0", "$D5E0",
      radio_SidStereoAddressStart_callback, (void *)0xd5e0, 0,
      TUI_MENU_BEH_CLOSE, NULL, NULL },
    { NULL }
};

static tui_menu_item_def_t sid_triple_address_d5xx_submenu[] = {
    { "$D500", "$D500",
      radio_SidTripleAddressStart_callback, (void *)0xd500, 0,
      TUI_MENU_BEH_CLOSE, NULL, NULL },
    { "$D520", "$D520",
      radio_SidTripleAddressStart_callback, (void *)0xd520, 0,
      TUI_MENU_BEH_CLOSE, NULL, NULL },
    { "$D540", "$D540",
      radio_SidTripleAddressStart_callback, (void *)0xd540, 0,
      TUI_MENU_BEH_CLOSE, NULL, NULL },
    { "$D560", "$D560",
      radio_SidTripleAddressStart_callback, (void *)0xd560, 0,
      TUI_MENU_BEH_CLOSE, NULL, NULL },
    { "$D580", "$D580",
      radio_SidTripleAddressStart_callback, (void *)0xd580, 0,
      TUI_MENU_BEH_CLOSE, NULL, NULL },
    { "$D5A0", "$D5A0",
      radio_SidTripleAddressStart_callback, (void *)0xd5a0, 0,
      TUI_MENU_BEH_CLOSE, NULL, NULL },
    { "$D5C0", "$D5C0",
      radio_SidTripleAddressStart_callback, (void *)0xd5c0, 0,
      TUI_MENU_BEH_CLOSE, NULL, NULL },
    { "$D5E0", "$D5E0",
      radio_SidTripleAddressStart_callback, (void *)0xd5e0, 0,
      TUI_MENU_BEH_CLOSE, NULL, NULL },
    { NULL }
};

static tui_menu_item_def_t sid_stereo_address_d6xx_submenu[] = {
    { "$D600", "$D600",
      radio_SidStereoAddressStart_callback, (void *)0xd600, 0,
      TUI_MENU_BEH_CLOSE, NULL, NULL },
    { "$D620", "$D620",
      radio_SidStereoAddressStart_callback, (void *)0xd620, 0,
      TUI_MENU_BEH_CLOSE, NULL, NULL },
    { "$D640", "$D640",
      radio_SidStereoAddressStart_callback, (void *)0xd640, 0,
      TUI_MENU_BEH_CLOSE, NULL, NULL },
    { "$D660", "$D660",
      radio_SidStereoAddressStart_callback, (void *)0xd660, 0,
      TUI_MENU_BEH_CLOSE, NULL, NULL },
    { "$D680", "$D680",
      radio_SidStereoAddressStart_callback, (void *)0xd680, 0,
      TUI_MENU_BEH_CLOSE, NULL, NULL },
    { "$D6A0", "$D6A0",
      radio_SidStereoAddressStart_callback, (void *)0xd6a0, 0,
      TUI_MENU_BEH_CLOSE, NULL, NULL },
    { "$D6C0", "$D6C0",
      radio_SidStereoAddressStart_callback, (void *)0xd6c0, 0,
      TUI_MENU_BEH_CLOSE, NULL, NULL },
    { "$D6E0", "$D6E0",
      radio_SidStereoAddressStart_callback, (void *)0xd6e0, 0,
      TUI_MENU_BEH_CLOSE, NULL, NULL },
    { NULL }
};

static tui_menu_item_def_t sid_triple_address_d6xx_submenu[] = {
    { "$D600", "$D600",
      radio_SidTripleAddressStart_callback, (void *)0xd600, 0,
      TUI_MENU_BEH_CLOSE, NULL, NULL },
    { "$D620", "$D620",
      radio_SidTripleAddressStart_callback, (void *)0xd620, 0,
      TUI_MENU_BEH_CLOSE, NULL, NULL },
    { "$D640", "$D640",
      radio_SidTripleAddressStart_callback, (void *)0xd640, 0,
      TUI_MENU_BEH_CLOSE, NULL, NULL },
    { "$D660", "$D660",
      radio_SidTripleAddressStart_callback, (void *)0xd660, 0,
      TUI_MENU_BEH_CLOSE, NULL, NULL },
    { "$D680", "$D680",
      radio_SidTripleAddressStart_callback, (void *)0xd680, 0,
      TUI_MENU_BEH_CLOSE, NULL, NULL },
    { "$D6A0", "$D6A0",
      radio_SidTripleAddressStart_callback, (void *)0xd6a0, 0,
      TUI_MENU_BEH_CLOSE, NULL, NULL },
    { "$D6C0", "$D6C0",
      radio_SidTripleAddressStart_callback, (void *)0xd6c0, 0,
      TUI_MENU_BEH_CLOSE, NULL, NULL },
    { "$D6E0", "$D6E0",
      radio_SidTripleAddressStart_callback, (void *)0xd6e0, 0,
      TUI_MENU_BEH_CLOSE, NULL, NULL },
    { NULL }
};

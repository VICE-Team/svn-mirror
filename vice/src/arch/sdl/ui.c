...
static const cmdline_option_t cmdline_options[] = {
    ...
    { "-menukeypageup", SET_RESOURCE, 1, NULL, NULL, "MenuKeyPageUp", NULL,
      USE_PARAM_STRING, USE_DESCRIPTION_STRING, IDGS_UNUSED, IDGS_UNUSED,
      "<key>", "Keycode of the menu page up key" },
    { "-menukeypagedown", SET_RESOURCE, 1, NULL, NULL, "MenuKeyPageDown", NULL,
      USE_PARAM_STRING, USE_DESCRIPTION_STRING, IDGS_UNUSED, IDGS_UNUSED,
      "<key>", "Keycode of the menu page down key" },
    { "-menukeyhome", SET_RESOURCE, 1, NULL, NULL, "MenuKeyHome", NULL,
      USE_PARAM_STRING, USE_DESCRIPTION_STRING, IDGS_UNUSED, IDGS_UNUSED,
      "<key>", "Keycode of the menu home key" },
    { "-menukeyend", SET_RESOURCE, 1, NULL, NULL, "MenuKeyEnd", NULL,
      USE_PARAM_STRING, USE_DESCRIPTION_STRING, IDGS_UNUSED, IDGS_UNUSED,

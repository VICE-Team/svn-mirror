...
rem make-watcom-bindist.bat - make binary distribution for the SDL 1.x OS/2 port
rem
rem Written by
...
set VICEDIR=SDLVICE-%VICEVERSION%-os2
...
echo OPENWATCOM SDL OS/2 port binary distribution directory generated as %VICEDIR%
goto end
:missingwatcom

...
enum {
    ...
    IDM_TOGGLE_CART_RESET, IDM_CART_VIC20_GENERIC, IDM_CART_VIC20_MEGACART,
    ...
    IDM_TOGGLE_STATUSBAR, IDM_JOYKEYS_TOGGLE, IDM_TOGGLE_OVERLAY, IDM_SWAP_JOYSTICK,
    ...
    IDM_DRIVE_ROM_SETTINGS, IDM_RAM_SETTINGS, IDM_RS232_SETTINGS, IDM_REU_SETTINGS,
    IDM_GEORAM_SETTINGS, IDM_RAMCART_SETTINGS, IDM_DQBB_SETTINGS, IDM_ISEPIC_SETTINGS,
    IDM_PLUS60K_SETTINGS, IDM_PLUS256K_SETTINGS, IDM_EASYFLASH_SETTINGS,
    IDM_C64_256K_SETTINGS, IDM_IDE64_SETTINGS, IDM_C128_SETTINGS, IDM_VIC_SETTINGS,
    IDM_CBM2_SETTINGS, IDM_PET_MODEL, IDM_PET_SETTINGS, IDM_PLUS4_SETTINGS,
    IDM_TFE_SETTINGS, IDM_ACIA_SETTINGS, IDM_RS232USER_SETTINGS, IDM_NETWORK_SETTINGS,
    ...
    IDM_CONTRIBUTORS, IDM_LICENSE, IDM_WARRANTY,
};

...
enum {
    ...
    IDM_DRIVE_SETTINGS,
    IDM_PRINTER_SETTINGS, IDM_DATASETTE_SETTINGS, IDM_VICII_SETTINGS,
    IDM_JOY_SETTINGS, IDM_JOY_DEVICE_SELECTION, IDM_JOY_FIRE_SELECTION,
    IDM_KEYBOARD_SETTINGS, IDM_MOUSE_SETTINGS, IDM_SOUND_SETTINGS,
    IDM_SID_SETTINGS, IDM_COMPUTER_ROM_SETTINGS, IDM_DRIVE_ROM_SETTINGS,
    IDM_RAM_SETTINGS, IDM_RS232_SETTINGS, IDM_REU_SETTINGS,
    IDM_GEORAM_SETTINGS, IDM_RAMCART_SETTINGS, IDM_DQBB_SETTINGS,
    IDM_ISEPIC_SETTINGS, IDM_PLUS60K_SETTINGS, IDM_PLUS256K_SETTINGS,
    IDM_EASYFLASH_SETTINGS, IDM_C64_256K_SETTINGS, IDM_MAGIC_VOICE_SETTINGS,
    IDM_EXPERT_SETTINGS, IDM_IDE64_SETTINGS, IDM_C128_SETTINGS,

...
enum {
  ...
  IDM_CART_ATTACH_AR, IDM_CART_ATTACH_AR3, IDM_CART_ATTACH_AR4,
  IDM_CART_ATTACH_STARDOS, IDM_CART_ATTACH_AT, IDM_CART_ATTACH_EPYX,
  ...
  IDM_CART_VIC20_GENERIC, IDM_CART_VIC20_MEGACART, IDM_CART_VIC20_FINAL_EXPANSION,
  IDM_CART_VIC20_SMART_ATTACH,
  ...
  IDM_TOGGLE_OVERLAY,
  IDM_SWAP_JOYSTICK,
  IDM_SWAP_USERPORT_JOYSTICK,
  IDM_TOGGLE_SOUND,
  IDM_IEEE488,
  IDM_TOGGLE_DRIVE_TRUE_EMULATION,
  IDM_TOGGLE_AUTOSTART_HANDLE_TDE,
  ...
  IDM_C64_256K_SETTINGS, IDM_IDE64_SETTINGS, IDM_C128_SETTINGS,
  IDM_VIC_SETTINGS, IDM_CBM2_SETTINGS, IDM_PET_MODEL, IDM_PET_SETTINGS,
  ...
  IDM_C64DTV_SETTINGS, IDM_SFX_SE_SETTINGS, IDM_TOGGLE_SFX_SS,
  
  IDM_SETTINGS_SAVE_FILE, IDM_SETTINGS_LOAD_FILE,
  IDM_SETTINGS_SAVE, IDM_SETTINGS_LOAD, IDM_SETTINGS_DEFAULT,
  IDM_TOGGLE_SAVE_SETTINGS_ON_EXIT, IDM_TOGGLE_CONFIRM_ON_EXIT,

  IDM_LANGUAGE_ENGLISH, IDM_LANGUAGE_DANISH, IDM_LANGUAGE_GERMAN,
  IDM_LANGUAGE_FRENCH, IDM_LANGUAGE_HUNGARIAN, IDM_LANGUAGE_ITALIAN,
  IDM_LANGUAGE_DUTCH, IDM_LANGUAGE_POLISH, IDM_LANGUAGE_SWEDISH, 
  IDM_LANGUAGE_TURKISH, IDM_LANGUAGE,

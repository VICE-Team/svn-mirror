...
enum {
    ...
    IDM_PET_MODEL_8296, IDM_PET_MODEL_SUPERPET, IDM_DEVICEMANAGER,
    ...
    IDM_CBM2_SETTINGS, IDM_PET_SETTINGS, IDM_PLUS4_SETTINGS, IDM_TFE_SETTINGS,
    ...
    IDM_RETROREPLAY_SETTINGS, IDM_V364_SPEECH_SETTINGS, IDM_SIDCART_SETTINGS,
    IDM_PETDWW_SETTINGS, IDM_FINAL_EXPANSION_WRITEBACK, IDM_FP_WRITEBACK,
    IDM_MEGACART_WRITEBACK, IDM_MEGACART_WRITEBACK_FILE, IDM_DIGIMAX_SETTINGS,
    IDM_C64DTV_SETTINGS, IDM_SFX_SE_SETTINGS, IDM_SFX_SS_SETTINGS,
    IDM_TOGGLE_SFX_SS, IDM_BURST_MOD, IDM_SETTINGS_SAVE_FILE,

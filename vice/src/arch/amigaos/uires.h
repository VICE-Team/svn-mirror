...
enum {
    ...
    IDM_C128_MODEL_C128_NTSC, IDM_C128_MODEL_C128DCR_NTSC, IDM_DEVICEMANAGER,
    ...
    IDM_TED_SETTINGS, IDM_JOY_SETTINGS,
    IDM_JOY_DEVICE_SELECTION, IDM_JOY_FIRE_SELECTION, IDM_KEYBOARD_SETTINGS,
    IDM_MOUSE_SETTINGS, IDM_SOUND_SETTINGS, IDM_SID_SETTINGS, IDM_CIA_SETTINGS,
    ...
    IDM_PETREU_SETTINGS, IDM_MMC64_SETTINGS, IDM_MMCREPLAY_SETTINGS,
    IDM_RETROREPLAY_SETTINGS, IDM_V364_SPEECH_SETTINGS,

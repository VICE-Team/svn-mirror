...
enum {
    ...
    IDM_TOGGLE_DOUBLESIZE, IDM_TOGGLE_DOUBLESCAN, IDM_TOGGLE_VDC_DOUBLESIZE,
    ...
    IDM_SYNC_FACTOR_NTSCOLD, IDM_MOUSE, IDM_PS2_MOUSE, IDM_VIDEO_SETTINGS,
    ...
    IDM_C64_MODEL_CUSTOM, IDM_PLUS_MODEL_C16_PAL, IDM_PLUS_MODEL_C16_NTSC,
    IDM_PLUS_MODEL_PLUS4_PAL, IDM_PLUS_MODEL_PLUS4_NTSC,
    IDM_PLUS_MODEL_V364_NTSC, IDM_PLUS_MODEL_C232_NTSC, IDM_DEVICEMANAGER,

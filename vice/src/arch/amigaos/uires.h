...
enum {
    ...
    IDM_TOGGLE_VDC_DOUBLESIZE, IDM_TOGGLE_VDC_DOUBLESCAN,
    ...
    IDM_VIDEO_SETTINGS, IDM_AUTOSTART_SETTINGS, IDM_C64_MODEL_C64_PAL,
    ...
    IDM_SFX_SS_SETTINGS, IDM_TOGGLE_SFX_SS,
    ...
    IDM_LANGUAGE_ITALIAN, IDM_LANGUAGE_KOREAN, IDM_LANGUAGE_DUTCH, IDM_LANGUAGE_POLISH,
    IDM_LANGUAGE_RUSSIAN, IDM_LANGUAGE_SWEDISH, IDM_LANGUAGE_TURKISH, IDM_LANGUAGE,

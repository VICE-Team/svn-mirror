...
enum {
    ...
    IDM_CART_VIC20_GENERIC, IDM_CART_VIC20_FP, IDM_CART_VIC20_MEGACART,
    ...
    IDM_CART_VIC20_8KB_A000, IDM_CART_VIC20_4KB_B000, IDM_CART_ATTACH_C0LO,
    IDM_CART_ATTACH_C0HI, IDM_CART_ATTACH_C1LO, IDM_CART_ATTACH_C1HI,
    IDM_CART_ATTACH_C2LO, IDM_CART_ATTACH_C2HI, IDM_CART_DETACH,
    ...
    IDM_TOGGLE_DOUBLESIZE, IDM_TOGGLE_DOUBLESCAN, IDM_TOGGLE_VERTICAL_STRETCH,
    IDM_TOGGLE_VDC_DOUBLESIZE,
    IDM_TOGGLE_VDC_DOUBLESCAN, IDM_TOGGLE_VDC64KB, IDM_VDC_REV_0,
    IDM_VDC_REV_1, IDM_VDC_REV_2, IDM_TOGGLE_STATUSBAR, IDM_JOYKEYS_TOGGLE,
    IDM_OPPOSITE_JOY_DIR, IDM_TOGGLE_OVERLAY, IDM_SWAP_JOYSTICK,
    IDM_SWAP_USERPORT_JOYSTICK, IDM_TOGGLE_SOUND, IDM_IEEE488,
    ...
    IDM_SYNC_FACTOR_NTSCOLD, IDM_MOUSE, IDM_PS2_MOUSE,
    IDM_AUTOSTART_SETTINGS, IDM_C64_MODEL_C64_PAL, IDM_C64_MODEL_C64C_PAL,
    IDM_C64_MODEL_C64_OLD_PAL, IDM_C64_MODEL_C64_NTSC,
    ...
    IDM_C64DTV_MODEL_V3_NTSC, IDM_C64DTV_MODEL_HUMMER_NTSC, IDM_DEVICEMANAGER,
    IDM_TOGGLE_AUDIO_LEAK, IDM_PALETTE_SETTINGS, IDM_COLOR_SETTINGS,
    IDM_RENDER_FILTER, IDM_CRT_EMULATION_SETTINGS, IDM_TOGGLE_AUDIO_LEAK_2,
    IDM_PALETTE_SETTINGS_2, IDM_COLOR_SETTINGS_2, IDM_RENDER_FILTER_2,
    IDM_CRT_EMULATION_SETTINGS_2,
    IDM_DRIVE_SETTINGS, IDM_PRINTER_SETTINGS, IDM_DATASETTE_SETTINGS,
    ...
    IDM_SOUND_SETTINGS, IDM_SID_SETTINGS, IDM_COMPUTER_ROM_SETTINGS,
    IDM_DRIVE_ROM_SETTINGS, IDM_RAM_SETTINGS, IDM_RS232_SETTINGS,
    ...
    IDM_MAGIC_VOICE_SETTINGS, IDM_EXPERT_SETTINGS, IDM_IDE64_SETTINGS,
    IDM_C128_SETTINGS, IDM_VIC_SETTINGS, IDM_CBM2_SETTINGS, IDM_PET_MODEL,
    IDM_PET_SETTINGS, IDM_PLUS4_SETTINGS, IDM_TFE_SETTINGS, IDM_ACIA_SETTINGS,
    IDM_RS232USER_SETTINGS, IDM_NETWORK_SETTINGS, IDM_PETREU_SETTINGS,
    IDM_MMC64_SETTINGS, IDM_MMCREPLAY_SETTINGS, IDM_V364_SPEECH_SETTINGS,
    IDM_SIDCART_SETTINGS, IDM_PETDWW_SETTINGS, IDM_FINAL_EXPANSION_WRITEBACK,
    IDM_FP_WRITEBACK, IDM_MEGACART_WRITEBACK, IDM_MEGACART_WRITEBACK_FILE,
    IDM_DIGIMAX_SETTINGS, IDM_C64DTV_SETTINGS, IDM_SFX_SE_SETTINGS,
    IDM_SFX_SS_SETTINGS, IDM_TOGGLE_SFX_SS, IDM_SETTINGS_SAVE_FILE,
    ...
    IDM_TOGGLE_USERPORT_DAC, IDM_CART_PLUS4_SMART_ATTACH
};

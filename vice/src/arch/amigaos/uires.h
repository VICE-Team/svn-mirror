...
enum {
    ...
    IDM_CART_VIC20_FINAL_EXPANSION,
    ...
    IDM_VIC20_MODEL_VIC20_PAL, IDM_VIC20_MODEL_VIC20_NTSC, IDM_VIC20_MODEL_VIC21,
    ...
    IDM_VIC_SETTINGS, IDM_JOYPORT_SETTINGS,
    ...
    IDM_PETCOLOUR_SETTINGS, IDM_ENABLE_PETHRE,
    IDM_FINAL_EXPANSION_WRITEBACK, IDM_UM_WRITEBACK, IDM_FP_WRITEBACK,
    IDM_MEGACART_WRITEBACK, IDM_IO2_RAM_ENABLE, IDM_IO3_RAM_ENABLE,
    IDM_MEGACART_WRITEBACK_FILE, IDM_DIGIMAX_SETTINGS, IDM_DS12C887RTC_SETTINGS,
    IDM_C64DTV_SETTINGS,
    IDM_SFX_SE_SETTINGS, IDM_SFX_SS_SETTINGS, IDM_TOGGLE_SFX_SS,
    IDM_TOGGLE_USERPORT_RTC, IDM_TOGGLE_USERPORT_RTC_SAVE, IDM_BURST_MOD,

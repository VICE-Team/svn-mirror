...
enum {
    ...
    IDM_IO2_RAM_ENABLE, IDM_IO3_RAM_ENABLE, IDM_MEGACART_WRITEBACK_FILE,
    ...
    IDM_TOGGLE_SFX_SS, IDM_TOGGLE_USERPORT_RTC_58321A,
    IDM_TOGGLE_USERPORT_RTC_58321A_SAVE, IDM_BURST_MOD, IDM_SETTINGS_SAVE_FILE,

...
static struct TranslateNewMenu UI_MENU_NAME[] = {
  ...
  TITLE(IDMS_SETTINGS, NULL)
    ITEM(IDMS_PLUS4_MODEL_SETTINGS,       NULL, NULL)
      SUB(IDMS_C16_PAL,                   NULL, IDM_PLUS_MODEL_C16_PAL)
      SUB(IDMS_C16_NTSC,                  NULL, IDM_PLUS_MODEL_C16_NTSC)
      SUB(IDMS_PLUS4_PAL,                 NULL, IDM_PLUS_MODEL_PLUS4_PAL)
      SUB(IDMS_PLUS4_NTSC,                NULL, IDM_PLUS_MODEL_PLUS4_NTSC)
      SUB(IDMS_V364_NTSC,                 NULL, IDM_PLUS_MODEL_V364_NTSC)
      SUB(IDMS_C232_NTSC,                 NULL, IDM_PLUS_MODEL_C232_NTSC)

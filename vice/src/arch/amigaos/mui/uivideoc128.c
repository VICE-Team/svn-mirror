...
static ui_to_from_t ui_to_from[] = {
    ...
    { NULL, MUI_TYPE_CYCLE, "VICIIExternalPalette", ui_external_palette_enable, ui_external_palette_enable_values, NULL },
    { NULL, MUI_TYPE_FILENAME, "VICIIPaletteFile", NULL, NULL, NULL },
    ...
    { NULL, MUI_TYPE_FILENAME, "VDCPaletteFile", NULL, NULL, NULL },
    UI_END /* mandatory */
};
...
static ULONG BrowseVICII(struct Hook *hook, Object *obj, APTR arg)
{
    ...
    if (fname != NULL) {
        set(ui_to_from[7].object, MUIA_String_Contents, fname);
    }
...
static ULONG BrowseVDC( struct Hook *hook, Object *obj, APTR arg )
{
    ...
    if (fname != NULL) {
        set(ui_to_from[11].object, MUIA_String_Contents, fname);
    }

...
static APTR build_computer_gui(void)
{
  ...
  ui = GroupObject,
    ...
    FILENAME(ui_to_from_computer[3].object, "Editor", hook_object_computer[3])
    FILENAME(ui_to_from_computer[4].object, "ROM 9", hook_object_computer[4])
    FILENAME(ui_to_from_computer[5].object, "ROM A", hook_object_computer[5])
    FILENAME(ui_to_from_computer[6].object, "ROM B", hook_object_computer[6])
    OK_CANCEL_BUTTON
  End;
...
void ui_pet_computer_rom_settings_dialog(video_canvas_t *canvas)
{
  APTR window;
...
void ui_pet_drive_rom_settings_dialog(video_canvas_t *canvas)
{
  APTR window;

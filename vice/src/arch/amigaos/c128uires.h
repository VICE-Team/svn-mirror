...
static struct TranslateNewMenu UI_MENU_NAME[] = {
  ...
  TITLE(IDMS_SETTINGS, NULL)
    ...
    ITEM(IDMS_CART_IO_SETTINGS,           NULL, NULL)
      ...
      SUBTOGGLE(IDMS_ENABLE_USERPORT_RTC_58321A, NULL, IDM_TOGGLE_USERPORT_RTC_58321A)
      SUBTOGGLE(IDMS_USERPORT_RTC_58321A_SAVE,   NULL, IDM_TOGGLE_USERPORT_RTC_58321A_SAVE)
    ITEMSEPARATOR()

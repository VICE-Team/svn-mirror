...
/* ru */ { IDS_ATTACH_FUNCTION_LOW_CART_RU, "Attach cartridge image for Function Low" },
...
/* ru */ { IDS_ATTACH_FUNCTION_HIGH_CART_RU, "Attach cartridge image for Function High" },

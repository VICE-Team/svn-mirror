...
#endif /* CIA2_TIMER_DEBUG */

#endif /* CIA2_USE_INLINE */
...
{
    cia2_tai = tai_clk;
    maincpu_set_alarm_clk(A_CIA2TA, tai_clk);
}
...
{
    cia2_tbi = tbi_clk;
    maincpu_set_alarm_clk(A_CIA2TB, tbi_clk);
}

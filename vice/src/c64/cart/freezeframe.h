...
extern void freezeframe_config_setup(BYTE *rawcart);
extern int freezeframe_bin_attach(const char *filename, BYTE *rawcart);
extern int freezeframe_crt_attach(FILE *fd, BYTE *rawcart);

...
static const cmdline_option_t cmdline_options[] = {
    { "-IDE64image1", SET_RESOURCE, 1,
      ...
      IDGS_UNUSED, IDCLS_SPECIFY_IDE64_NAME,
      "<Name>", NULL },
    ...
    { "-IDE64cyl1", SET_RESOURCE, 1,
      ...
      USE_PARAM_STRING, USE_DESCRIPTION_ID,
      IDGS_UNUSED, IDCLS_SET_AMOUNT_CYLINDERS_IDE64,
      "<value>", NULL },
    ...
    { "-IDE64hds1", SET_RESOURCE, 1,
      ...
      USE_PARAM_STRING, USE_DESCRIPTION_ID,
      IDGS_UNUSED, IDCLS_SET_AMOUNT_HEADS_IDE64,
      "<value>", NULL },
    ...
    { "-IDE64sec1", SET_RESOURCE, 1,
      ...
      USE_PARAM_STRING, USE_DESCRIPTION_ID,
      IDGS_UNUSED, IDCLS_SET_AMOUNT_SECTORS_IDE64,
      "<value>", NULL },
    ...
    { "-IDE64version", SET_RESOURCE, 1,
      ...
      USE_PARAM_STRING, USE_DESCRIPTION_ID,
      IDGS_UNUSED, IDCLS_IDE64_VERSION,
      "<value>", NULL },
#ifdef HAVE_NETWORK
    ...
    { "-IDE64USBAddress", SET_RESOURCE, 1,
      ...
      USE_PARAM_STRING, USE_DESCRIPTION_ID,
      IDGS_UNUSED, IDCLS_IDE64_USB_SERVER_ADDRESS,
      "<Name>", NULL },
#endif

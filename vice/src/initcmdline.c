...
static const cmdline_option_t common_cmdline_options[] = {
    ...
    { "-config", CALL_FUNCTION, 1,
      ...
      USE_PARAM_STRING, USE_DESCRIPTION_ID,
      IDGS_UNUSED, IDCLS_SPECIFY_CONFIG_FILE,
      "<filename>", NULL },
    { "-dumpconfig", CALL_FUNCTION, 1,
      cmdline_dumpconfig, NULL, NULL, NULL,
      USE_PARAM_STRING, USE_DESCRIPTION_ID,
      IDGS_UNUSED, IDCLS_SPECIFY_DUMPCONFIG_FILE,
      "<filename>", NULL },
    ...
    { "-limitcycles", CALL_FUNCTION, 1,
      ...
      USE_PARAM_STRING, USE_DESCRIPTION_ID,
      IDGS_UNUSED, IDCLS_LIMIT_CYCLES,
      "<value>", NULL },
...
static const cmdline_option_t cmdline_options[] = {
    { "-autostart", CALL_FUNCTION, 1,
      ...
      USE_PARAM_STRING, USE_DESCRIPTION_ID,
      IDGS_UNUSED, IDCLS_ATTACH_AND_AUTOSTART,
      "<Name>", NULL },
    { "-autoload", CALL_FUNCTION, 1,
      cmdline_autoload, NULL, NULL, NULL,
      USE_PARAM_STRING, USE_DESCRIPTION_ID,
      IDGS_UNUSED, IDCLS_ATTACH_AND_AUTOLOAD,
      "<Name>", NULL },
    { "-1", CALL_FUNCTION, 1,
      cmdline_attach, (void *)1, NULL, NULL,
      USE_PARAM_STRING, USE_DESCRIPTION_ID,
      IDGS_UNUSED, IDCLS_ATTACH_AS_TAPE,
      "<Name>", NULL },
    { "-8", CALL_FUNCTION, 1,
      cmdline_attach, (void *)8, NULL, NULL,
      USE_PARAM_STRING, USE_DESCRIPTION_ID,
      IDGS_UNUSED, IDCLS_ATTACH_AS_DISK_8,
      "<Name>", NULL },
    { "-9", CALL_FUNCTION, 1,
      cmdline_attach, (void *)9, NULL, NULL,
      USE_PARAM_STRING, USE_DESCRIPTION_ID,
      IDGS_UNUSED, IDCLS_ATTACH_AS_DISK_9,
      "<Name>", NULL },
    { "-10", CALL_FUNCTION, 1,
      cmdline_attach, (void *)10, NULL, NULL,
      USE_PARAM_STRING, USE_DESCRIPTION_ID,
      IDGS_UNUSED, IDCLS_ATTACH_AS_DISK_10,
      "<Name>", NULL },
    { "-11", CALL_FUNCTION, 1,
      cmdline_attach, (void *)11, NULL, NULL,
      USE_PARAM_STRING, USE_DESCRIPTION_ID,
      IDGS_UNUSED, IDCLS_ATTACH_AS_DISK_11,
      "<Name>", NULL },
    CMDLINE_LIST_END
};

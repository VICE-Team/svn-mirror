...
extern serial_t serialdevices[SERIAL_MAXDEVICES];
...
void serialattention(void)
{
    ...
    if (b == 0x3f) {
        iec_unlisten(TrapDevice);
    } else if (b == 0x5f) {
        iec_untalk(TrapDevice);
    } else {
        switch (b & 0xf0) {
          case 0x20:
          case 0x40:
            ...
            break;
          case 0x60:
            iec_listentalk(TrapDevice, b);
            break;
          case 0xe0:
            iec_close(TrapDevice, b);
            break;
          case 0xf0:
            iec_open(TrapDevice, b);
            break;
        }
    }

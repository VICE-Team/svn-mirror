...
int rawimage_read_sector(const disk_image_t *image, BYTE *buf, unsigned int track,
                         unsigned int sector)
{
    return blockdev_read_sector(buf, track, sector);
}

int rawimage_write_sector(disk_image_t *image, const BYTE *buf, unsigned int track,
                          unsigned int sector)
{

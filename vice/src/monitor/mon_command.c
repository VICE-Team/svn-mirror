...
static const mon_cmds_t mon_cmd_array[] = {
    ...
    { "device", "dev",
      ...
      "[c:|8:|9:|10:|11:]", NULL, NO_FILENAME_ARG },
    ...
    { "attach", "",
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      "<%s> <%s>", 2,
      { IDGS_UNUSED, IDGS_DEVICE, IDGS_UNUSED, IDGS_UNUSED },
      IDGS_MON_ATTACH_DESCRIPTION,
      "<filename> <%s>", NULL, FILENAME_ARG },

    { "autostart", "",
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      "<%s> [%s]", 2,
      { IDGS_UNUSED, IDGS_FILE_INDEX, IDGS_UNUSED, IDGS_UNUSED },
    ...
    { "autoload", "",
      ...
      "<filename> [%s]", "autoload given disk/tape image or program", FILENAME_ARG },
    ...
    { "bload", "bl",
      ...
      "\"<filename>\" <%s> <address>", NULL, FILENAME_ARG },

    { "block_read", "br",
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      "<%s> <%s> [<%s>]", 3,
      { IDGS_TRACK, IDGS_SECTOR, IDGS_UNUSED, IDGS_UNUSED },
      IDGS_MON_BLOCK_READ_DESCRIPTION,
      "<%s> <%s> [<address>]", NULL, NO_FILENAME_ARG },
    ...
    { "bsave", "bs",
      ...
      "\"<filename>\" <%s> <address1> <address2>", NULL, FILENAME_ARG },

...
static const mon_cmds_t mon_cmd_array[] = {
    { "", "",
      ...
      NULL, 0,
      { IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED },
    ...
    { "bank", "",
      ...
      "[<%s>] [%s]", 2,
      { IDGS_MEMSPACE, IDGS_BANKNAME, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED },
    ...
    { "cpu", "",
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      "<%s>", 1,
      { IDGS_TYPE, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED },
    ...
    { "cpuhistory", "chis",
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      "[<%s>]", 1,
      { IDGS_COUNT, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED },
    ...
    { "dump", "",
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      "\"<%s>\"", 1,
      { IDGS_FILENAME, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED },
    ...
    { "goto", "g",
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      "<%s>", 1,
      { IDGS_ADDRESS, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED },
    ...
    { "registers", "r",
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      "[<%s> = <%s> [, <%s> = <%s>]*]", 4,
      { IDGS_REG_NAME, IDGS_NUMBER, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED },
    ...
    { "add_label", "al",
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      "[<%s>] <%s> <%s> [<%s>] [<%s>]] [<%s>]", 6,
      { IDGS_MEMSPACE, IDGS_ADDRESS, IDGS_LABEL, IDGS_DATA_TYPE, IDGS_SIZE, IDGS_COMMENT },
    ...
    { "delete_label", "dl",
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      "[<%s>] <%s>", 2,
      { IDGS_MEMSPACE, IDGS_LABEL, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED },
    ...
    { "load_labels", "ll",
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      "[<%s>] \"<%s>\"", 2,
      { IDGS_MEMSPACE, IDGS_FILENAME, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED },
    ...
    { "show_labels", "shl",
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      "[<%s>]", 1,
      { IDGS_MEMSPACE, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED },
    ...
    { ">", "",
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      "[<%s>] <%s>", 2,
      { IDGS_ADDRESS, IDGS_DATA_LIST, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED },
    ...
    { "a", "",
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      "<%s> [ <%s> [: <%s>]* ]", 3,
      { IDGS_ADDRESS, IDGS_INSTRUCTION, IDGS_INSTRUCTION, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED },
    ...
    { "compare", "c",
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      "<%s> <%s>", 2,
      { IDGS_ADDRESS_RANGE, IDGS_ADDRESS, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED },
    ...
    { "disass", "d",
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      "[<%s> [<%s>]]", 2,
      { IDGS_ADDRESS, IDGS_ADDRESS, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED },
    ...
    { "fill", "f",
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      "<%s> <%s>", 2,
      { IDGS_ADDRESS_RANGE, IDGS_DATA_LIST, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED },
    ...
    { "i", "",
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      "<%s>", 1,
      { IDGS_ADDRESS_OPT_RANGE, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED },
    ...
    { "mem", "m",
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      "[<%s>] [<%s>]", 2,
      { IDGS_DATA_TYPE, IDGS_ADDRESS_OPT_RANGE, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED },
    ...
    { "memmapsave", "mmsave",
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      "\"<%s>\" <%s>", 2,
      { IDGS_FILENAME, IDGS_FORMAT, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED },
    ...
    { "memmapshow", "mmsh",
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      "[<%s>] [<%s>]", 2,
      { IDGS_MASK, IDGS_ADDRESS_OPT_RANGE, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED },
    ...
    { "break", "bk",
      ...
      { IDGS_ADDRESS, IDGS_ADDRESS, IDGS_COND_EXPR, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED },
    ...
    { "command", "",
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      "<%s> \"<%s>\"", 2,
      { IDGS_CHECKNUM, IDGS_COMMAND, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED },
    ...
    { "condition", "cond",
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      "<%s> if <%s>", 2,
      { IDGS_CHECKNUM, IDGS_COND_EXPR, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED },
    ...
    { "delete", "del",
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      "<%s>", 1,
      { IDGS_CHECKNUM, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED },
    ...
    { "ignore", "",
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      "<%s> [<%s>]", 2,
      { IDGS_CHECKNUM, IDGS_COUNT, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED },
    ...
    { "@", "",
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      "<%s>", 1,
      { IDGS_DISK_COMMAND, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED },
    ...
    { "attach", "",
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      "<%s> <%s>", 2,
      { IDGS_FILENAME, IDGS_DEVICE, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED },
    ...
    { "autostart", "",
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      "<%s> [%s]", 2,
      { IDGS_FILENAME, IDGS_FILE_INDEX, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED },
    ...
    { "bload", "bl",
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      "\"<%s>\" <%s> <%s>", 3,
      { IDGS_FILENAME, IDGS_DEVICE, IDGS_ADDRESS, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED },
    ...
    { "block_read", "br",
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      "<%s> <%s> [<%s>]", 3,
      { IDGS_TRACK, IDGS_SECTOR, IDGS_ADDRESS, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED },
    ...
    { "bsave", "bs",
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      "\"<%s>\" <%s> <%s1> <%s2>", 4,
      { IDGS_FILENAME, IDGS_DEVICE, IDGS_ADDRESS, IDGS_ADDRESS, IDGS_UNUSED, IDGS_UNUSED },
    ...
    { "cd", "",
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      "<%s>", 1,
      { IDGS_DIRECTORY, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED },
    ...
    { "detach", "",
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      "<%s>", 1,
      { IDGS_DEVICE, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED },
    ...
    { "~", "",
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      "<%s>", 1,
      { IDGS_NUMBER, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED },
    ...
    { "help", "?",
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      "[<%s>]", 1,
      { IDGS_COMMAND, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED },
    ...
    { "keybuf", "",
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      "\"<%s>\"", 1,
      { IDGS_STRING, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED },
    ...
    { "print", "p",
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      "<%s>", 1,
      { IDGS_EXPRESSION, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED },
    ...
    { "resourceget", "resget",
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      "\"<%s>\"", 1,
      { IDGS_RESOURCE, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED },
    ...
    { "resourceset", "resset",
      USE_PARAM_ID, USE_DESCRIPTION_ID,
      "\"<%s>\" \"<%s>\"", 2,
      { IDGS_RESOURCE, IDGS_VALUE, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED, IDGS_UNUSED },

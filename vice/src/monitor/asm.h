...
enum asm_addr_mode {
    ...
    ASM_ADDR_MODE_ZERO_PAGE_BIT0_RELATIVE,
    ASM_ADDR_MODE_ZERO_PAGE_BIT1_RELATIVE,
    ASM_ADDR_MODE_ZERO_PAGE_BIT2_RELATIVE,
    ASM_ADDR_MODE_ZERO_PAGE_BIT3_RELATIVE,
    ASM_ADDR_MODE_ZERO_PAGE_BIT4_RELATIVE,
    ASM_ADDR_MODE_ZERO_PAGE_BIT5_RELATIVE,
    ASM_ADDR_MODE_ZERO_PAGE_BIT6_RELATIVE,
    ASM_ADDR_MODE_ZERO_PAGE_BIT7_RELATIVE,
    ASM_ADDR_MODE_ZERO_PAGE_BIT0,
    ASM_ADDR_MODE_ZERO_PAGE_BIT1,
    ASM_ADDR_MODE_ZERO_PAGE_BIT2,
    ASM_ADDR_MODE_ZERO_PAGE_BIT3,
    ASM_ADDR_MODE_ZERO_PAGE_BIT4,
    ASM_ADDR_MODE_ZERO_PAGE_BIT5,
    ASM_ADDR_MODE_ZERO_PAGE_BIT6,
    ASM_ADDR_MODE_ZERO_PAGE_BIT7,

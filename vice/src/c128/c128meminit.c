...
void c128meminit(void)
{
    ...
    for (j = 0; j < 128; j += 64) {
        ...
        for (i = 0x80; i <= 0xbf; i++) {
            ...
            mem_read_base_set(4 + j, i, ext_function_rom - 0x8000);
            mem_read_base_set(5 + j, i, ext_function_rom - 0x8000);
            mem_read_base_set(6 + j, i, mem_ram);
            mem_read_base_set(7 + j, i, mem_ram);
            ...
            mem_read_base_set(12 + j, i, ext_function_rom - 0x8000);
            mem_read_base_set(13 + j, i, ext_function_rom - 0x8000);
            mem_read_base_set(14 + j, i, mem_ram);
            mem_read_base_set(15 + j, i, mem_ram);
            ...
            mem_read_base_set(20 + j, i, ext_function_rom - 0x8000);
            mem_read_base_set(21 + j, i, ext_function_rom - 0x8000);
            mem_read_base_set(22 + j, i, mem_ram);
            mem_read_base_set(23 + j, i, mem_ram);
            ...
            mem_read_base_set(28 + j, i, ext_function_rom - 0x8000);
            mem_read_base_set(29 + j, i, ext_function_rom - 0x8000);
            mem_read_base_set(30 + j, i, mem_ram);
            mem_read_base_set(31 + j, i, mem_ram);
            ...
            mem_read_base_set(34 + j, i, NULL);
            mem_read_base_set(35 + j, i, NULL);
            mem_read_base_set(36 + j, i, ext_function_rom - 0x8000);
            mem_read_base_set(37 + j, i, ext_function_rom - 0x8000);
            mem_read_base_set(38 + j, i, mem_ram + 0x10000);
            ...
            mem_read_base_set(42 + j, i, NULL);
            mem_read_base_set(43 + j, i, NULL);
            mem_read_base_set(44 + j, i, ext_function_rom - 0x8000);
            mem_read_base_set(45 + j, i, ext_function_rom - 0x8000);
            mem_read_base_set(46 + j, i, mem_ram + 0x10000);
            ...
            mem_read_base_set(50 + j, i, NULL);
            mem_read_base_set(51 + j, i, NULL);
            mem_read_base_set(52 + j, i, ext_function_rom - 0x8000);
            mem_read_base_set(53 + j, i, ext_function_rom - 0x8000);
            mem_read_base_set(54 + j, i, mem_ram + 0x10000);
            ...
            mem_read_base_set(58 + j, i, NULL);
            mem_read_base_set(59 + j, i, NULL);
            mem_read_base_set(60 + j, i, ext_function_rom - 0x8000);
            mem_read_base_set(61 + j, i, ext_function_rom - 0x8000);
            mem_read_base_set(62 + j, i, mem_ram + 0x10000);
    ...
    for (i = 0xd0; i <= 0xdf; i++) {
        ...
        mem_read_base_set(16, i, mem_ram);
        mem_read_base_set(17, i, mem_ram);
        mem_read_base_set(18, i, mem_ram);
        mem_read_base_set(19, i, mem_ram);
        mem_read_base_set(20, i, mem_ram);
        mem_read_base_set(21, i, mem_ram);
        mem_read_base_set(22, i, mem_ram);
        mem_read_base_set(23, i, mem_ram);

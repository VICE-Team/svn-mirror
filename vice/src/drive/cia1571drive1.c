...
int cia1571d1_undump(FILE * p)
{
    ...
    snapshot_read_byte(p, &cia1571d1[CIA_PRA]);
    snapshot_read_byte(p, &cia1571d1[CIA_PRB]);
    snapshot_read_byte(p, &cia1571d1[CIA_DDRA]);
    snapshot_read_byte(p, &cia1571d1[CIA_DDRB]);

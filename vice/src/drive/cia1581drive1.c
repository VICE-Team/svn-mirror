...
int cia1581d1_write_snapshot_module(FILE * p)
{
    ...
    snapshot_write_byte(p, cia1581d1[CIA_PRB]);
    snapshot_write_byte(p, cia1581d1[CIA_DDRA]);
    snapshot_write_byte(p, cia1581d1[CIA_DDRB]);
    snapshot_write_word(p, cia1581d1_tac);
    snapshot_write_word(p, cia1581d1_tbc);
    snapshot_write_byte(p, cia1581d1[CIA_TOD_TEN]);
    snapshot_write_byte(p, cia1581d1[CIA_TOD_SEC]);
    snapshot_write_byte(p, cia1581d1[CIA_TOD_MIN]);
    snapshot_write_byte(p, cia1581d1[CIA_TOD_HR]);
    snapshot_write_byte(p, cia1581d1[CIA_SDR]);
    snapshot_write_byte(p, cia1581d1[CIA_ICR]);
    snapshot_write_byte(p, cia1581d1[CIA_CRA]);
    snapshot_write_byte(p, cia1581d1[CIA_CRB]);

    snapshot_write_word(p, cia1581d1_tal);
    snapshot_write_word(p, cia1581d1_tbl);
    snapshot_write_byte(p, peek_cia1581d1(CIA_ICR));
    snapshot_write_byte(p, (cia1581d1_tat ? 0x40 : 0) | (cia1581d1_tbt ? 0x80 : 0));
    snapshot_write_byte(p, cia1581d1sr_bits);
    snapshot_write_byte(p, cia1581d1todalarm[0]);
    snapshot_write_byte(p, cia1581d1todalarm[1]);
    snapshot_write_byte(p, cia1581d1todalarm[2]);
    ...
    snapshot_write_byte(p, cia1581d1todlatch[2]);
    snapshot_write_byte(p, cia1581d1todlatch[3]);

    snapshot_write_dword(p, drive1_int_status.alarm_clk[A_CIA1581D1TOD] - drive_clk[1]);
...
int cia1581d1_read_snapshot_module(FILE * p)
{
    ...
    snapshot_read_word(p, &word);
    cia1581d1_tbc = word;
    snapshot_read_byte(p, &cia1581d1[CIA_TOD_TEN]);
    snapshot_read_byte(p, &cia1581d1[CIA_TOD_SEC]);
    snapshot_read_byte(p, &cia1581d1[CIA_TOD_MIN]);
    ...
    snapshot_read_byte(p, &cia1581d1[CIA_CRB]);
    ...
    snapshot_read_byte(p, &cia1581d1todalarm[0]);
    snapshot_read_byte(p, &cia1581d1todalarm[1]);
    snapshot_read_byte(p, &cia1581d1todalarm[2]);
    snapshot_read_byte(p, &cia1581d1todalarm[3]);
    ...
    snapshot_read_byte(p, &cia1581d1todlatch[0]);
    snapshot_read_byte(p, &cia1581d1todlatch[1]);
    snapshot_read_byte(p, &cia1581d1todlatch[2]);
    snapshot_read_byte(p, &cia1581d1todlatch[3]);
    ...
    if((cia1581d1[CIA_CRB] & 0x41) == 0x41) cia1581d1_tbs = CIAT_COUNTTA;

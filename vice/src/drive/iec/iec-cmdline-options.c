...
static cmdline_option_t cmdline_options[] = {
    ...
    { "-drive8extend", SET_RESOURCE, 1, NULL, NULL, "Drive8ExtendImagePolicy",
      ...
      "Set drive 8 40 track extension policy (0: never, 1: ask, 2: on access)"},    { "-drive9extend", SET_RESOURCE, 1, NULL, NULL, "Drive9ExtendImagePolicy",
      (void *)DRIVE_EXTEND_NEVER, "<method>",
      "Set drive 9 40 track extension policy (0: never, 1: ask, 2: on access)"},    { "-dos1541", SET_RESOURCE, 1, NULL, NULL, "DosName1541", "dos1541",

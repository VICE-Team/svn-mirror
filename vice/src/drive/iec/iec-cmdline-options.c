...
static const cmdline_option_t cmdline_options[] = {
    { "-dos1540", SET_RESOURCE, 1,
      ...
      IDGS_UNUSED, IDCLS_SPECIFY_1540_DOS_ROM_NAME,
      "<Name>", NULL },
    { "-dos1541", SET_RESOURCE, 1,
      NULL, NULL, "DosName1541", NULL,
      USE_PARAM_STRING, USE_DESCRIPTION_ID,
      IDGS_UNUSED, IDCLS_SPECIFY_1541_DOS_ROM_NAME,
      "<Name>", NULL },
    { "-dos1541II", SET_RESOURCE, 1,
      NULL, NULL, "DosName1541II", NULL,
      USE_PARAM_STRING, USE_DESCRIPTION_ID,
      IDGS_UNUSED, IDCLS_SPECIFY_1541_II_DOS_ROM_NAME,
      "<Name>", NULL },
    { "-dos1570", SET_RESOURCE, 1,
      NULL, NULL, "DosName1570", NULL,
      USE_PARAM_STRING, USE_DESCRIPTION_ID,
      IDGS_UNUSED, IDCLS_SPECIFY_1570_DOS_ROM_NAME,
      "<Name>", NULL },
    { "-dos1571", SET_RESOURCE, 1,
      NULL, NULL, "DosName1571", NULL,
      USE_PARAM_STRING, USE_DESCRIPTION_ID,
      IDGS_UNUSED, IDCLS_SPECIFY_1571_DOS_ROM_NAME,
      "<Name>", NULL },
    { "-dos1581", SET_RESOURCE, 1,
      NULL, NULL, "DosName1581", NULL,
      USE_PARAM_STRING, USE_DESCRIPTION_ID,
      IDGS_UNUSED, IDCLS_SPECIFY_1581_DOS_ROM_NAME,
      "<Name>", NULL },
    { "-dos2000", SET_RESOURCE, 1,
      NULL, NULL, "DosName2000", NULL,
      USE_PARAM_STRING, USE_DESCRIPTION_ID,
      IDGS_UNUSED, IDCLS_SPECIFY_2000_DOS_ROM_NAME,
      "<Name>", NULL },
    { "-dos4000", SET_RESOURCE, 1,
      NULL, NULL, "DosName4000", NULL,
      USE_PARAM_STRING, USE_DESCRIPTION_ID,
      IDGS_UNUSED, IDCLS_SPECIFY_4000_DOS_ROM_NAME,
      "<Name>", NULL },
    CMDLINE_LIST_END
};

...
int cia1581d0_undump(FILE * p)
{
    ...
    snapshot_read_byte(p, &cia1581d0[CIA_PRA]);
    snapshot_read_byte(p, &cia1581d0[CIA_PRB]);
    snapshot_read_byte(p, &cia1581d0[CIA_DDRA]);
    snapshot_read_byte(p, &cia1581d0[CIA_DDRB]);

...
printf("CIA1581D0: write cia1581d0int=%02x, cia1581d0ier=%02x\n", cia1581d0int, cia1581d0ier);
#endif
...
#ifdef CIA1581D0_DUMP_DEBUG
printf("CIA1581D0: snap read rdi=%02x\n", byte);
printf("CIA1581D0: snap setting rdi to %d (rclk=%d)\n", cia1581d0rdi, drive_clk[0]);
#endif

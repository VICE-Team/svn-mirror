...
int cia1571d0_undump(FILE * p)
{
    ...
    snapshot_read_byte(p, &cia1571d0[CIA_PRA]);
    snapshot_read_byte(p, &cia1571d0[CIA_PRB]);
    snapshot_read_byte(p, &cia1571d0[CIA_DDRA]);
    snapshot_read_byte(p, &cia1571d0[CIA_DDRB]);

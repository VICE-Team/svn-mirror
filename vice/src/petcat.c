...
static basic_list_t basic_list[] = {
   /* version    num  max   load   off start tokens             verselect    64 ce fe name */
    { B_1,        75, 0xCB, 0x0801, 0, 0,    NULL, /* fix */    "1p",        0, 0, 0, "Basic v1.0 (PET)" },
    ...
    { B_4,        15, 0xDA, 0x0801, 0, 0xCC, petkwcc,           "40",        0, 0, 0, "Basic v4.0 (PET/CBM2)" },
    ...
    { B_VIC4,     20, 0xDF, 0x0801, 0, 0xCC, vic4kwcc,          "4v",        0, 0, 0, "Basic v2.0 with Basic v4.0 extension (VIC20)" },
    { B_VIC5,     38, 0xF1, 0x0801, 0, 0xCC, vic5kwcc,          "5",         0, 0, 0, "Basic v2.0 with Basic v5.0 extension (VIC20)" },

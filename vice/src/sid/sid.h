...
#define RESIDFP_COMBINED_WAVEFORM_STRENGTH_MIN      0
#define RESIDFP_COMBINED_WAVEFORM_STRENGTH_MAX      2
#define RESIDFP_COMBINED_WAVEFORM_STRENGTH_ONE      1
#define RESIDFP_COMBINED_WAVEFORM_STRENGTH_DEFAULT  1

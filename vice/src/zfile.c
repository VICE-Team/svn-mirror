...
static const char * const extensions[] = {
    ARCHDEP_EXT_SEP_STR "d64",
    ARCHDEP_EXT_SEP_STR "d67",
    ARCHDEP_EXT_SEP_STR "d71",
    ARCHDEP_EXT_SEP_STR "d80",
    ARCHDEP_EXT_SEP_STR "d81",
    ARCHDEP_EXT_SEP_STR "d82",
    ARCHDEP_EXT_SEP_STR "d1m",
    ARCHDEP_EXT_SEP_STR "d2m",
    ARCHDEP_EXT_SEP_STR "d4m",
    ARCHDEP_EXT_SEP_STR "g64",
    ARCHDEP_EXT_SEP_STR "p64",
    ARCHDEP_EXT_SEP_STR "g41",
    ARCHDEP_EXT_SEP_STR "x64",
    ARCHDEP_EXT_SEP_STR "dsk",
    ARCHDEP_EXT_SEP_STR "t64",
    ARCHDEP_EXT_SEP_STR "p00",
    ARCHDEP_EXT_SEP_STR "prg",
    ARCHDEP_EXT_SEP_STR "lnx",
    ARCHDEP_EXT_SEP_STR "tap",
    NULL
};

/*
 * c610snapshot.c - CBM-II snapshot handling.
 *
 * Written by
...
static log_t c610_snapshot_log = LOG_ERR;
...
int c610_snapshot_write_module(snapshot_t *p, int save_roms)
{
...
int c610_snapshot_read_module(snapshot_t *p)
{

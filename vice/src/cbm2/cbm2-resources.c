...
static const resource_t resources[] = {
    ...
    { "Ram1", RES_INTEGER, (resource_value_t)0,
      RES_EVENT_NO, NULL,
      (void *)&cart1_ram, set_cart1_ram, NULL },
    { "Ram2", RES_INTEGER, (resource_value_t)0,
      RES_EVENT_NO, NULL,
      (void *)&cart2_ram, set_cart2_ram, NULL },
    { "Ram4", RES_INTEGER, (resource_value_t)0,
      RES_EVENT_NO, NULL,
      (void *)&cart4_ram, set_cart4_ram, NULL },
    { "Ram6", RES_INTEGER, (resource_value_t)0,
      RES_EVENT_NO, NULL,
      (void *)&cart6_ram, set_cart6_ram, NULL },
    { "RamC", RES_INTEGER, (resource_value_t)0,
      RES_EVENT_NO, NULL,
      (void *)&cartC_ram, set_cartC_ram, NULL },
    { "UseVicII", RES_INTEGER, (resource_value_t)0,
      RES_EVENT_SAME, NULL,
      (void *)&use_vicii, set_use_vicii, NULL },
    { "ModelLine", RES_INTEGER, (resource_value_t)2,
      RES_EVENT_SAME, NULL,
      (void *)&cbm2_model_line, set_cbm2_model_line, NULL },
    ...
    { "KeymapBusinessUKSymFile", RES_STRING, (resource_value_t)KBD_CBM2_SYM_UK,
      RES_EVENT_NO, NULL,
      (void *)&machine_keymap_file_list[0],
      keyboard_set_keymap_file, (void *)0 },
    { "KeymapBusinessUKPosFile", RES_STRING, (resource_value_t)KBD_CBM2_POS_UK,
      RES_EVENT_NO, NULL,
      (void *)&machine_keymap_file_list[1],
      keyboard_set_keymap_file, (void *)1 },
    { "KeymapGraphicsSymFile", RES_STRING, (resource_value_t)KBD_CBM2_SYM_GR,
      RES_EVENT_NO, NULL,
      (void *)&machine_keymap_file_list[2],
      keyboard_set_keymap_file, (void *)2 },
    { "KeymapGraphicsPosFile", RES_STRING, (resource_value_t)KBD_CBM2_POS_GR,
      RES_EVENT_NO, NULL,
      (void *)&machine_keymap_file_list[3],
      keyboard_set_keymap_file, (void *)3 },
    { "KeymapBusinessDESymFile", RES_STRING, (resource_value_t)KBD_CBM2_SYM_DE,
      RES_EVENT_NO, NULL,
      (void *)&machine_keymap_file_list[4],
      keyboard_set_keymap_file, (void *)4 },
    { "KeymapBusinessDEPosFile", RES_STRING, (resource_value_t)KBD_CBM2_POS_DE,
      RES_EVENT_NO, NULL,

...
static io_source_t debugcart_device = {
    ...
    0xdaff, 0xdaff, 0xff,     /* range for the device, reg:$daff */
...
/*static const cbm2export_resource_t export_res = {
...
{
    int n = (int)value;
    fprintf(stdout, "DBGCART: exit(%d) cycles elapsed: %llu\n", n, maincpu_clk);
...
{
    /*if (cbm2export_add(&export_res) < 0) {
        return -1;
    }*/
    fprintf(stdout, "DBGCART: enabled\n");

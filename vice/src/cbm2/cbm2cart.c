...
static const cmdline_option_t cmdline_options[] =
{
    ...
    { "-cart1", SET_RESOURCE, 1,
      ...
      USE_PARAM_STRING, USE_DESCRIPTION_ID,
      IDGS_UNUSED, IDCLS_SPECIFY_CART_ROM_1000_NAME,
      "<Name>", NULL },
    { "-cart2", SET_RESOURCE, 1,
      NULL, NULL, "Cart2Name", NULL,
      USE_PARAM_STRING, USE_DESCRIPTION_ID,
      IDGS_UNUSED, IDCLS_SPECIFY_CART_ROM_2000_NAME,
      "<Name>", NULL },
    { "-cart4", SET_RESOURCE, 1,
      NULL, NULL, "Cart4Name", NULL,
      USE_PARAM_STRING, USE_DESCRIPTION_ID,
      IDGS_UNUSED, IDCLS_SPECIFY_CART_ROM_4000_NAME,
      "<Name>", NULL },
    { "-cart6", SET_RESOURCE, 1,
      NULL, NULL, "Cart6Name", NULL,
      USE_PARAM_STRING, USE_DESCRIPTION_ID,
      IDGS_UNUSED, IDCLS_SPECIFY_CART_ROM_6000_NAME,
      "<Name>", NULL },
    CMDLINE_LIST_END
};

...
/* fr */ {IDCLS_AUTOSTART_LOAD_TO_BASIC_START_FR, "Lors de l'autodémarrage, charger au BASIC (sans ',1')"},
...
/* fr */ {IDCLS_AUTOSTART_LOAD_WITH_1_FR, "À l'autodémarrage, charger avec ',1'"},
...
/* fr */ {IDCLS_ENABLE_AUTOSTART_HANDLE_TDE_FR, "Activer l'Émulation Réelle de Lecteur à l'autodémarrage"},
...
/* fr */ {IDCLS_DISABLE_AUTOSTART_HANDLE_TDE_FR, "Ne pas utiliser l'émulation réelle de lecteur à l'autodémarrage"},
...
/* fr */ {IDCLS_SET_AUTOSTART_DELAY_FR, "Définir le délai initial d'autodémarrage (0: utiliser défaut)"},
...
#ifdef HAS_TRANSLATION
/* da */ {IDCLS_ENABLE_AUTOSTART_RANDOM_DELAY_DA, "Aktivér tilfældig autostart-forsinkelse"},
...
#ifdef HAS_TRANSLATION
/* da */ {IDCLS_DISABLE_AUTOSTART_RANDOM_DELAY_DA, "Deaktivér tilfældig autostart-forsinkelse"},
...
/* fr */ {IDCLS_DISABLE_AUTOSTART_RANDOM_DELAY_FR, "Désactiver le délai aléatoire initial d'autodémarrage."},
...
/* fr */ {IDCLS_DISABLE_OEM_JOY_FR, "Désactiver l'adaptateur OEM Joystick port utilisateur"},
...
/* de */ {IDCLS_SET_ACIA_BASE_DE, "Basis Adresse für ACIA Erweiterung"},
...
/* pl */ {IDCLS_SET_ACIA_BASE_PL, "Ustaw adres bazowy kartrid¿a ACIA"},
...
/* pl */ {IDCLS_SPECIFY_KEYMAP_FILE_INDEX_PL, "Podaj indeks uk³adu klawiatury (0=symbol, 1=pozycja, 2=symbol (u¿ytkownika), 3=pozycja (u¿ytkownika))"},
...
/* nl */ {IDCLS_SPECIFY_KEYBOARD_TYPE_NL, "Geef geëmuleerd toetsenbord soort"},
...
/* pl */ {IDCLS_SPECIFY_KEYBOARD_MAPPING_PL, "Okre¶l uk³ad klawiatury hosta"},
...
/* fr */ {IDCLS_SET_C128_MODEL_FR, "Définir le modèle C128 (c128/c128dcr, pal/ntsc)"},
...
/* de */ {IDCLS_SET_C128_MACHINE_TYPE_DE, "Wähle C128 Modell (0: International, 1: Finnisch, 2: Französisch, 3: Deutsch, 4: Italienisch , 5: Norwegisch, 6: Schwedisch, 7: Schweiz)"},
/* es */ {IDCLS_SET_C128_MACHINE_TYPE_ES, "Seleccionar tipo de máquina C128 (0: Internacional, 1: Finlandesa, 2: Francesa, 3: Alemana, 4: Italiana, 5: Noruega, 6: Sueca, 7: Suiza)"},
...
/* pl */ {IDCLS_SET_C128_MACHINE_TYPE_PL, "Wybierz typ maszyny C128 (0: Miêdzynarodowy, 1: Fiñski, 2: Francuski, 3: Niemiecki, 4: W³oski, 5: Norweski, 6: Szwedzki, 7: Szwajcarski)"},
...
/* fr */ {IDCLS_SPECIFY_IEEE488_INTERFACE_NAME_FR, "spécifier le nom de l'image d'interface IEEE-488"},
...
#ifdef HAS_TRANSLATION
/* da */ {IDCLS_ENABLE_GEORAM_DA, "Aktivér GEO-RAM-udviddelsesenheden"},
/* de */ {IDCLS_ENABLE_GEORAM_DE, "GEO-RAM Erweiterung aktivieren"},
/* es */ {IDCLS_ENABLE_GEORAM_ES, "Permitir unidad expansión GEO-RAM"},
/* fr */ {IDCLS_ENABLE_GEORAM_FR, "Activer l'unité d'expansion GEO-RAM"},
...
#ifdef HAS_TRANSLATION
/* da */ {IDCLS_DISABLE_GEORAM_DA, "Deaktivér GEO-RAM-udviddelsesenhed"},
...
/* fr */ {IDCLS_DISABLE_GEORAM_FR, "Désactiver l'unité d'expansion GEO-RAM"},
...
/* ru */ {IDCLS_DISABLE_GEORAM_RU, "ÀÐáèØàÕÝØÕ ßÐÜïâØ GEORAM"},
...
/* de */ {IDCLS_SPECIFY_GEORAM_NAME_DE, "GEORAM Imagedatei wählen"},
...
/* fr */ {IDCLS_ALLOW_WRITING_TO_GEORAM_IMAGE_FR, "Permettre l'écriture sur l'image GEO-RAM"},
...
/* fr */ {IDCLS_DO_NOT_WRITE_TO_GEORAM_IMAGE_FR, "Ne pas écrire sur l'image GEO-RAM"},
...
/* fr */ {IDCLS_SWAP_CART_IO_FR, "Échanger le mappage E/S (mapper I/O-1 cartouche à I/O-3 VIC20 et I/O-2 cartouche à I/O-2 VIC20)"},
...
/* fr */ {IDCLS_DONT_SWAP_CART_IO_FR, "Ne pas échanger le mappage E/S (mapper I/O-1 cartouche à I/O-2 VIC20 et I/O-2 cartouche à I/O-3 VIC20)"},
...
/* fr */ {IDCLS_MAP_CART_IO_2_FR, "Échanger le mappage E/S (mapper I/O cartouche à I/O-2 VIC20)"},
...
/* fr */ {IDCLS_MAP_CART_IO_3_FR, "Ne pas échanger le mappage E/S (mapper I/O cartouche à I/O-3 VIC20)"},
...
/* fr */ {IDCLS_GEORAM_SIZE_FR, "Taille de l'unité d'expansion GEO-RAM"},
...
/* fr */ {IDCLS_DISABLE_USERPORT_DAC_FR, "Désactiver DAC port utilisateur comme sortie de son"},
...
#ifdef HAS_TRANSLATION
/* da */ {IDCLS_ENABLE_RAMCART_DA, "Aktivér RamCart-udviddelsen"},
...
/* de */ {IDCLS_SPECIFY_RAMCART_NAME_DE, "Name für RAMCART Imagedatei wählen"},
...
/* fr */ {IDCLS_ALLOW_WRITING_TO_RAMCART_IMAGE_FR, "Permetre l'écriture à l'image RAMCart"},
...
/* fr */ {IDCLS_DO_NOT_WRITE_TO_RAMCART_IMAGE_FR, "Ne pas écrire sur l'image RAMCart"},
...
/* de */ {IDCLS_RAMCART_SIZE_DE, "Größe der RAMCART Erweiterung. (64/128)"},
/* es */ {IDCLS_RAMCART_SIZE_ES, "Tamaño expansión RAMCart. (64/128)"},
...
/* fr */ {IDCLS_DISABLE_DQBB_FR, "Désactiver Double Quick Brown Box"},
...
/* fr */ {IDCLS_SPECIFY_DQBB_NAME_FR, "Spécifier nom de fichier Double Quick Brown Box"},
...
/* fr */ {IDCLS_ALLOW_WRITING_TO_DQBB_IMAGE_FR, "Permettre l'écriture à l'image DQBB"},
...
/* fr */ {IDCLS_DO_NOT_WRITE_TO_DQBB_IMAGE_FR, "Ne pas écrire sur l'image  DQBB"},
...
#ifdef HAS_TRANSLATION
/* da */ {IDCLS_DISABLE_ISEPIC_DA, "Deaktivér ISEPIC-cartridget"},
/* de */ {IDCLS_DISABLE_ISEPIC_DE, "ISEPIC Modul deaktivieren"},
/* es */ {IDCLS_DISABLE_ISEPIC_ES, "Deshabilitar cartucho ISEPIC"},
/* fr */ {IDCLS_DISABLE_ISEPIC_FR, "Désactiver la cartouche ISEPIC"},
...
/* es */ {IDCLS_ENABLE_ISEPIC_SWITCH_ES, "Permitir conmutación ISEPIC"},
...
/* es */ {IDCLS_DISABLE_ISEPIC_SWITCH_ES, "Deshabilitar conmutación ISEPIC"},
...
/* fr */ {IDCLS_ALLOW_WRITING_TO_ISEPIC_IMAGE_FR, "Permettre l'écriture sur l'image ISEPIC"},
...
/* fr */ {IDCLS_DO_NOT_WRITE_TO_ISEPIC_IMAGE_FR, "Ne pas écrire sur l'image ISEPIC"},
...
/* de */ {IDCLS_SPECIFY_MAGICVOICE_IMAGE_NAME_DE, "Name für Magic Voice ROM Imagedatei wählen"},
...
/* pl */ {IDCLS_SPECIFY_MAGICVOICE_IMAGE_NAME_PL, "Okre¶l nazwê obrazu ROM Magic Voice"},
...
/* de */ {IDCLS_SPECIFY_MMC64_IMAGE_NAME_DE, "Name der MMC64 Imagedatei wählen"},
...
/* es */ {IDCLS_SPECIFY_MMC64_REVISION_ES, "Especificar revisión MMC64 (0: Rev A, 1: Rev B)"},
...
/* pl */ {IDCLS_SPECIFY_MMC64_REVISION_PL, "Okre¶l wersjê MMC64 (0: Rev A, 1: Rev B)"},
...
/* de */ {IDCLS_MMC64_BIOS_READ_ONLY_DE, "MMC64 BIOS nicht speichern bei Änderung"},
...
/* fr */ {IDCLS_MMC_REPLAY_CARD_WRITE_ENABLE_FR, "Permetre l'écriture à l'image MMC Replay"},
...
/* fr */ {IDCLS_MMC_REPLAY_CARD_WRITE_DISABLE_FR, "Interdire l'écriture à l'image MMC Replay"},
...
/* fr */ {IDCLS_MMC_REPLAY_EEPROM_WRITE_ENABLE_FR, "Permetre l'écriture à l'image MMC Replay EEPROM"},
...
/* fr */ {IDCLS_MMC_REPLAY_EEPROM_WRITE_DISABLE_FR, "Interdire l'écriture à l'image MMC Replay EEPROM"},
...
/* fr */ {IDCLS_MMC_REPLAY_RESCUE_MODE_DISABLE_FR, "Désactiver le mode de secours MMC Replay"},
...
/* fr */ {IDCLS_DO_NOT_WRITE_TO_MMC_REPLAY_IMAGE_FR, "Interdire l'écriture à l'image MMC Replay"},
...
/* fr */ {IDCLS_ENABLE_SAVE_RR_ROM_AT_EXIT_FR, "Activer la sauvegarde du ROM RR à la fin du programme"},
...
/* fr */ {IDCLS_DISABLE_SAVE_RR_ROM_AT_EXIT_FR, "Désactiver la sauvegarde du ROM RR à la fin du programme"},
...
/* pl */ {IDCLS_RR_REVISION_PL, "Okre¶l wersjê RR (0: Retro Replay, 1: Nordic Replay)"},
...
#ifdef HAS_TRANSLATION
/* da */ {IDCLS_ENABLE_REU_DA, "Aktivér RAM-udviddelsesenheden"},
...
/* de */ {IDCLS_SPECIFY_REU_NAME_DE, "Namen für REU Imagedatei wählen"},
...
/* fr */ {IDCLS_ALLOW_WRITING_TO_REU_IMAGE_FR, "Permetre l'écriture à l'image REU"},
...
/* fr */ {IDCLS_DO_NOT_WRITE_TO_REU_IMAGE_FR, "Interdire l'écriture à l'image REU"},
...
/* de */ {IDCLS_REU_SIZE_DE, "Größe der RAM Erweiterung. (128/256/512/1024/2048/4096/8192/16384)"},
/* es */ {IDCLS_REU_SIZE_ES, "Tamaño de la unidad de expansión RAM. (128/256/512/1024/2048/4096/8192/16384)"},
...
/* pl */ {IDCLS_REU_SIZE_PL, "Wielko¶æ jednostki rozszerzenia RAM. (128/256/512/1024/2048/4096/8192/16384)"},
...
/* de */ {IDCLS_ETHERNETCART_BASE_DE, "Basis Adresse für Ethernet Erweiterungmodul"},
...
#ifdef HAS_TRANSLATION
/* da */ {IDCLS_ATTACH_RAW_CAPTURE_CART_DA, "Tilslut råt 8kB Capture cartridge image"},
...
/* fr */ {IDCLS_ATTACH_RAW_EXPERT_CART_FR, "Insérer une image de Cartouche Expert 8 ko"},
...
#ifdef HAS_TRANSLATION
/* da */ {IDCLS_ATTACH_RAW_F64_CART_DA, "Tilslut råt 32kB Formel 64 image"},
...
#ifdef HAS_TRANSLATION
/* da */ {IDCLS_ATTACH_RAW_KINGSOFT_CART_DA, "Tilslut råt 24kB Snapshot 64 cartridge image"},
...
/* fr */ {IDCLS_DISABLE_EXPERT_CART_FR, "Désactiver la Cartouche Expert"},
...
/* it */ {IDCLS_SET_EXPERT_MODE_IT, "Imposta modalità Expert Cartridge (0: Off, 1: Prg, 2: On)"},
...
/* fr */ {IDCLS_ALLOW_WRITING_TO_EXPERT_IMAGE_FR, "Permettre l'écriture sur l'image Cartouche Expert"},
...
/* fr */ {IDCLS_DO_NOT_WRITE_TO_EXPERT_IMAGE_FR, "NE PAS permettre l'écriture sur l'image de Cartouche Expert"},
...
/* fr */ {IDCLS_DISABLE_CART_FR, "Désactiver la cartouche par défaut"},
...
/* de */ {IDCLS_SPECIFY_IDE64_NAME_DE, "Namen für IDE64 Imagedatei wählen"},
...
/* de */ {IDCLS_SET_AMOUNT_CYLINDERS_IDE64_DE, "Anzahl der Zylinder für IDE64 Emulation. (1..65535)"},
/* es */ {IDCLS_SET_AMOUNT_CYLINDERS_IDE64_ES, "Seleccionar número de cilindros para emulación IDE64 (1..65535)"},
...
/* pl */ {IDCLS_SET_AMOUNT_CYLINDERS_IDE64_PL, "Okre¶l liczbê cylindrów w emulacji IDE64. (1..65535)"},
...
/* de */ {IDCLS_SET_AMOUNT_HEADS_IDE64_DE, "Anzahl der Laufwerksköpfe für IDE64 Emulation. (1..16)"},
/* es */ {IDCLS_SET_AMOUNT_HEADS_IDE64_ES, "Seleccionar número de cabezas para emulación IDE64 (1..16)"},
...
/* pl */ {IDCLS_SET_AMOUNT_HEADS_IDE64_PL, "Okre¶l liczbê g³owic w emulacji IDE64. (1..16)"},
...
/* de */ {IDCLS_SET_AMOUNT_SECTORS_IDE64_DE, "Anzahl der Sektoren für IDE64 Emulation. (1..63)"},
/* es */ {IDCLS_SET_AMOUNT_SECTORS_IDE64_ES, "Seleccionar número de sectores para emulación IDE64 (1..63)"},
...
/* pl */ {IDCLS_SET_AMOUNT_SECTORS_IDE64_PL, "Okre¶l liczbê sektorów w emulacji IDE64. (1..63)"},
...
#ifdef HAS_TRANSLATION
/* da */ {IDCLS_ENABLE_DRIVE_SOUND_DA, "Aktivér emulering af lyd for diskettedrev"},
...
/* fr */ {IDCLS_ENABLE_DRIVE_SOUND_FR, "Activer l'émulation du son des lecteurs de disque"},
...
#ifdef HAS_TRANSLATION
/* da */ {IDCLS_DISABLE_DRIVE_SOUND_DA, "Deaktivér emulering af lyd for diskettedrev"},
...
/* fr */ {IDCLS_DISABLE_DRIVE_SOUND_FR, "Désactiver l'émulation du son des lecteurs disque"},
...
/* sv */ {IDCLS_SET_DRIVE_SOUND_VOLUME_SV, "Välj volym för ljudemulering för diskettstation (0-4000)"},
...
/* de */ {IDCLS_SET_SATURATION_DE, "Sättigung für intern berechneten Palette setzen"},
/* es */ {IDCLS_SET_SATURATION_ES, "Seleccionar saturación calculada en paleta interna"},
...
/* pl */ {IDCLS_SET_SATURATION_PL, "Okre¶l nasycenie wewnêtrznie obliczonej palety kolorystycznej"},
...
/* de */ {IDCLS_SET_CONTRAST_DE, "Kontrast für intern berechnete Palette setzen"},
...
/* pl */ {IDCLS_SET_CONTRAST_PL, "Okre¶l kontrast wewnêtrznie obliczonej palety kolorystycznej"},
...
/* de */ {IDCLS_SET_BRIGHTNESS_DE, "Helligkeit für intern berechnete Palette setzen"},
...
/* pl */ {IDCLS_SET_BRIGHTNESS_PL, "Okre¶l jasno¶æ wewnêtrznie obliczonej palety kolorystycznej"},
...
/* de */ {IDCLS_SET_GAMMA_DE, "Gamma für intern berechnete Palette setzen"},
...
/* pl */ {IDCLS_SET_GAMMA_PL, "Okre¶l jaskrawo¶æ wewnêtrznie obliczonej palety kolorystycznej"},
...
/* de */ {IDCLS_SET_TINT_DE, "Farbton für intern berechneten Palette setzen"},
...
/* pl */ {IDCLS_SET_TINT_PL, "Okre¶l odcieñ wewnêtrznie obliczonej palety kolorystycznej"},
...
/* de */ {IDCLS_SET_ODDLINES_PHASE_DE, "Phase für Farbträger in ungeraden Zeilen setzen"},
...
/* pl */ {IDCLS_SET_ODDLINES_PHASE_PL, "Okre¶l fazê no¶nika koloru w liniach nieparzystych"},
...
/* de */ {IDCLS_SET_ODDLINES_OFFSET_DE, "Phasenoffset für Farbträger in ungeraden Zeilen setzen"},
/* es */ {IDCLS_SET_ODDLINES_OFFSET_ES, "Seleccionar añadido fase trasporte color en lineas impares"},
...
/* pl */ {IDCLS_SET_ODDLINES_OFFSET_PL, "Okre¶l wyrównanie fazy no¶nika koloru w liniach nieparzystych"},
...
/* pl */ {IDCLS_SET_BLUR_PL, "Warto¶æ rozmycia w poziomie emulacji CRT"},
...
/* de */ {IDCLS_SET_SCANLINE_SHADE_DE, "Wert für Scanline Schatten für CRT Emulation"},
/* es */ {IDCLS_SET_SCANLINE_SHADE_ES, "Cantidad de lineas sombra escaneo para emulación CRT"},
...
/* pl */ {IDCLS_SET_SCANLINE_SHADE_PL, "Warto¶æ cieniowania linii wybierania emulacji CRT"},
...
/* pl */ {IDCLS_SPECIFY_OUTPUT_DEVICE_6_NAME_PL, "Okre¶l nazwê urz±dzenia wyj¶cia #6"},
...
/* fr */ {IDCLS_P_ENGINE_MODEL_FR, "<engin et modèle>"},
...
/* pl */ {IDCLS_AMOUNT_EXTRA_SIDS_PL, "liczba dodatkowych czipów SID (0..2)"},
...
/* fr */ {IDCLS_SPECIFY_SID_3_ADDRESS_FR, "Spécifier l'adresse de base pour le troisième SID"},
...
/* fr */ {IDCLS_RESID_FILTER_BIAS_FR, "Paramètre de polarisation de filtre reSID, pouvant être utilisé pour régler la polarisation du DAC en millivolts."},
...
/* de */ {IDCLS_HARDSID_MAIN_DE, "HardSID Gerät für SID Ausgabe (main)"},
...
/* nl */ {IDCLS_HARDSID_MAIN_NL, "Zet het HardSID apparaat voor de hoofd SID uitvoer"},
/* pl */ {IDCLS_HARDSID_MAIN_PL, "Okre¶l urz±dzenie HardSID dla g³ównego wyj¶cia SID"},
...
/* de */ {IDCLS_HARDSID_RIGHT_DE, "HardSID Gerät für SID Ausgabe (rechts)"},
...
/* nl */ {IDCLS_HARDSID_RIGHT_NL, "Zet het HardSID apparaat voor de rechter SID uitvoer"},
/* pl */ {IDCLS_HARDSID_RIGHT_PL, "Okre¶l urz±dzenie SID dla prawego wyj¶cia SID"},
...
/* de */ {IDCLS_ENABLE_HWSCALE_POSSIBLE_DE, "Hardwareunterstützung für Skalierung aktivieren"},
/* es */ {IDCLS_ENABLE_HWSCALE_POSSIBLE_ES, "Permitir escalado hardware"},
/* fr */ {IDCLS_ENABLE_HWSCALE_POSSIBLE_FR, ""},  /* fuzzy */
/* hu */ {IDCLS_ENABLE_HWSCALE_POSSIBLE_HU, ""},  /* fuzzy */
/* it */ {IDCLS_ENABLE_HWSCALE_POSSIBLE_IT, "Attiva la possibilità di ridimensionamento a livello hardware"},
/* ko */ {IDCLS_ENABLE_HWSCALE_POSSIBLE_KO, ""},  /* fuzzy */
/* nl */ {IDCLS_ENABLE_HWSCALE_POSSIBLE_NL, "Mogelijkheid van hardwareschaling inschakelen"},
/* pl */ {IDCLS_ENABLE_HWSCALE_POSSIBLE_PL, "W³±cz mo¿liwo¶æ skalowania sprzêtowego"},
...
/* de */ {IDCLS_DISABLE_HWSCALE_POSSIBLE_DE, "Hardwareunterstützung für Skalierung deaktivieren"},
/* es */ {IDCLS_DISABLE_HWSCALE_POSSIBLE_ES, "Deshabilitar escalado hardware"},
/* fr */ {IDCLS_DISABLE_HWSCALE_POSSIBLE_FR, ""},  /* fuzzy */
/* hu */ {IDCLS_DISABLE_HWSCALE_POSSIBLE_HU, ""},  /* fuzzy */
/* it */ {IDCLS_DISABLE_HWSCALE_POSSIBLE_IT, "Disattiva la possibilità di ridimensionamento a livello hardware"},
/* ko */ {IDCLS_DISABLE_HWSCALE_POSSIBLE_KO, ""},  /* fuzzy */
/* nl */ {IDCLS_DISABLE_HWSCALE_POSSIBLE_NL, "Mogelijkheid van hardwareschaling uitschakelen"},
/* pl */ {IDCLS_DISABLE_HWSCALE_POSSIBLE_PL, "Wy³±cz mo¿liwo¶æ skalowania sprzêtowego"},
...
/* nl */ {IDCLS_ENABLE_DOUBLE_SIZE_NL, "Dubbele grootte inschakelen"},
...
/* nl */ {IDCLS_ENABLE_DOUBLE_SCAN_NL, "Dubbele scan inschakelen"},
...
#ifdef HAS_TRANSLATION
/* da */ {IDCLS_ENABLE_AUDIO_LEAK_DA, "Aktivér audiolækage-emulering"},
/* de */ {IDCLS_ENABLE_AUDIO_LEAK_DE, "Audio Leak Emulation aktivieren"},
/* es */ {IDCLS_ENABLE_AUDIO_LEAK_ES, "Permitir emulación audio leak"},
/* fr */ {IDCLS_ENABLE_AUDIO_LEAK_FR, "Activer l'émulation de fuite audio"},
...
/* nl */ {IDCLS_ENABLE_AUDIO_LEAK_NL, "Audio lek emulatie inschakelen"},
...
#ifdef HAS_TRANSLATION
/* da */ {IDCLS_DISABLE_AUDIO_LEAK_DA, "Deaktivér audiolækage-emulering"},
...
/* fr */ {IDCLS_DISABLE_AUDIO_LEAK_FR, "Désactiver l'émulation de fuite audio"},
...
/* nl */ {IDCLS_DISABLE_AUDIO_LEAK_NL, "Audio lek emulatie uitschakelen"},
...
/* it */ {IDCLS_ENABLE_HARDWARE_SCALING_IT, "Attiva ridimensionamento a livello hardware"},
/* ko */ {IDCLS_ENABLE_HARDWARE_SCALING_KO, ""},  /* fuzzy */
/* nl */ {IDCLS_ENABLE_HARDWARE_SCALING_NL, "Hardwareschaling inschakelen"},
...
/* it */ {IDCLS_DISABLE_HARDWARE_SCALING_IT, "Disattiva ridimensionamento a livello hardware"},
...
/* nl */ {IDCLS_SET_VIDEO_FILTER_NL, "Selecteer rendering filter: (0: geen, 1: CRT emulatie, 2: Scale2x)"},
...
/* nl */ {IDCLS_SPECIFY_EXTERNAL_PALETTE_NAME_NL, "Geef de naam van het externe kleurenpaletbestand"},
...
/* nl */ {IDCLS_SELECT_FULLSCREEN_DEVICE_NL, "Selecteer volledig schermapparaat"},
...
/* nl */ {IDCLS_SELECT_FULLSCREEN_MODE_NL, "Volledig scherm-modus inschakelen"},
...
/* de */ {IDCLS_SET_DEVICE_TYPE_8_DE, "Gerätetyp für Gerät #8 (0: Kein, 1: Dateisystem, 2: OpenCBM, 3: Block Gerät)"},
...
/* nl */ {IDCLS_SET_DEVICE_TYPE_8_NL, "Stel het apparaatsoort in voor apparaat #8 (0: Geen, 1: Bestandssysteem, 2: OpenCBM, 3: Blok apparaat)"},
/* pl */ {IDCLS_SET_DEVICE_TYPE_8_PL, "Okre¶l typ urz±dzenia #8 (0: Brak, 1: System plików, 2: OpenCBM, 3: Urz±dzenie blokowe)"},
...
/* de */ {IDCLS_SET_DEVICE_TYPE_9_DE, "Gerätetyp für Gerät #9 (0: Kein, 1: Dateisystem, 2: OpenCBM, 3: Block Gerät)"},
...
/* nl */ {IDCLS_SET_DEVICE_TYPE_9_NL, "Stel het apparaatsoort in voor apparaat #9 (0: Geen, 1: Bestandssysteem, 2: OpenCBM, 3: Blok apparaat)"},
/* pl */ {IDCLS_SET_DEVICE_TYPE_9_PL, "Okre¶l typ urz±dzenia #8 (0: Brak, 1: System plików, 2: OpenCBM, 3: Urz±dzenie blokowe)"},
...
/* de */ {IDCLS_SET_DEVICE_TYPE_10_DE, "Gerätetyp für Gerät #10 (0: Kein, 1: Dateisystem, 2: OpenCBM, 3: Block Gerät)"},
...
/* nl */ {IDCLS_SET_DEVICE_TYPE_10_NL, "Stel het apparaatsoort in voor apparaat #10 (0: Geen, 1: Bestandssysteem, 2: OpenCBM, 3: Blok apparaat)"},
/* pl */ {IDCLS_SET_DEVICE_TYPE_10_PL, "Okre¶l typ urz±dzenia #8 (0: Brak, 1: System plików, 2: OpenCBM, 3: Urz±dzenie blokowe)"},
...
/* de */ {IDCLS_SET_DEVICE_TYPE_11_DE, "Gerätetyp für Gerät #11 (0: Kein, 1: Dateisystem, 2: OpenCBM, 3: Block Gerät)"},
...
/* nl */ {IDCLS_SET_DEVICE_TYPE_11_NL, "Stel het apparaatsoort in voor apparaat #11 (0: Geen, 1: Bestandssysteem, 2: OpenCBM, 3: Blok apparaat)"},
/* pl */ {IDCLS_SET_DEVICE_TYPE_11_PL, "Okre¶l typ urz±dzenia #8 (0: Brak, 1: System plików, 2: OpenCBM, 3: Urz±dzenie blokowe)"},
...
/* nl */ {IDCLS_TRACE_DRIVE0_CPU_NL, "Traceer de CPU van drive 0"},
...
/* nl */ {IDCLS_DONT_TRACE_DRIVE0_CPU_NL, "Traceer de CPU van drive 0 niet"},
...
/* nl */ {IDCLS_TRACE_DRIVE1_CPU_NL, "Traceer de CPU van drive 1"},
...
/* nl */ {IDCLS_DONT_TRACE_DRIVE1_CPU_NL, "Traceer de CPU van drive 1 niet"},
...
/* nl */ {IDCLS_TRACE_DRIVE2_CPU_NL, "Traceer de CPU van drive 2"},
...
/* nl */ {IDCLS_DONT_TRACE_DRIVE2_CPU_NL, "Traceer de CPU van drive 2 niet"},
...
/* nl */ {IDCLS_TRACE_DRIVE3_CPU_NL, "Traceer de CPU van drive 3"},
...
/* nl */ {IDCLS_DONT_TRACE_DRIVE3_CPU_NL, "Traceer de CPU van drive 3 niet"},
...
/* de */ {IDCLS_SET_AUTO_PLAYBACK_FRAMES_DE, "Frames für automatische Wiedergabe eingeben"},
...
/* nl */ {IDCLS_SET_AUTO_PLAYBACK_FRAMES_NL, "Stel het aantal automatische weergave frames in"},
/* pl */ {IDCLS_SET_AUTO_PLAYBACK_FRAMES_PL, "Ustaw liczbê klatek do automatycznego odegrania"},
...
/* nl */ {IDCLS_P_FRAMES_NL, "<frames>"},
/* pl */ {IDCLS_P_FRAMES_PL, "<klatki>"},
...
/* de */ {IDCLS_SET_EVENT_SNAPSHOT_DIR_DE, "Event Snapshot Verzeichnis wählen."},
/* es */ {IDCLS_SET_EVENT_SNAPSHOT_DIR_ES, "Seleccionar directorio eventos Instantaneas"},
...
/* nl */ {IDCLS_SET_EVENT_SNAPSHOT_DIR_NL, "Stel gebeurtenis momentopname map in"},
/* pl */ {IDCLS_SET_EVENT_SNAPSHOT_DIR_PL, "Ustaw katalog zrzutów zdarzeñ"},
...
/* de */ {IDCLS_SET_EVENT_START_SNAPSHOT_DE, "Snapshot speichern starten"},
/* es */ {IDCLS_SET_EVENT_START_SNAPSHOT_ES, "Seleccionar evento inicio Instantanea"},
...
/* nl */ {IDCLS_SET_EVENT_START_SNAPSHOT_NL, "Stel start gebeurtenis momentopname in"},
/* pl */ {IDCLS_SET_EVENT_START_SNAPSHOT_PL, "Ustaw zrzut pocz±tku zdarzenia"},
...
/* de */ {IDCLS_SET_EVENT_END_SNAPSHOT_DE, "Event Snapshot beenden"},
/* es */ {IDCLS_SET_EVENT_END_SNAPSHOT_ES, "Seleccionar evento fin Instantanea"},
...
/* nl */ {IDCLS_SET_EVENT_END_SNAPSHOT_NL, "Stel eind gebeurtenis momentopname in"},
/* pl */ {IDCLS_SET_EVENT_END_SNAPSHOT_PL, "Ustaw zrzut koñca zdarzenia"},
...
/* de */ {IDCLS_SET_EVENT_START_MODE_DE, "Event Start Modus (0: File speichern, 1: File laden, 2: Reset, 3: Playback)"},
/* es */ {IDCLS_SET_EVENT_START_MODE_ES, "Seleccionar modo inicio eventos (0: grabar fichero, 1: cargar fichero, 2: reinicio, 3: reproducir)"},
...
/* nl */ {IDCLS_SET_EVENT_START_MODE_NL, "Stel gebeurtenis start modus in (0: bestand opslaan, 1: bestand laden, 2: reset, 4: afspelen)"},
/* pl */ {IDCLS_SET_EVENT_START_MODE_PL, "Ustaw tryb rozpoczêcia zdarzenia (0: zapis pliku, 1: wczytanie pliku, 2: reset, 3: odegranie)"},
...
/* de */ {IDCLS_ENABLE_EVENT_IMAGE_INCLUDE_DE, "Disk Image inkludieren"},
...
/* nl */ {IDCLS_ENABLE_EVENT_IMAGE_INCLUDE_NL, "Insluiten van disk bestanden inschakelen"},
/* pl */ {IDCLS_ENABLE_EVENT_IMAGE_INCLUDE_PL, "W³±cz do³±czanie obrazów dyskietek"},
...
/* de */ {IDCLS_DISABLE_EVENT_IMAGE_INCLUDE_DE, "Disk Image exkludieren"},
...
/* nl */ {IDCLS_DISABLE_EVENT_IMAGE_INCLUDE_NL, "Insluiten van disk bestanden uitschakelen"},
/* pl */ {IDCLS_DISABLE_EVENT_IMAGE_INCLUDE_PL, "Wy³±cz do³±czanie obrazów dyskietek"},
...
/* de */ {IDCLS_SPECIFY_SAMPLER_DEVICE_DE, "Sample Gerät auswählen"},
...
/* ru */ {IDCLS_LIMIT_SPEED_TO_VALUE_RU, "¾ÓàÐÝØçØâì áÚÞàÞáâì íÜãÛïæØØ ÔÞ ÞßàÕÔÕÛÕÝÝÞÓÞ ×ÝÐçÕÝØï"},
...
/* fr */ {IDCLS_ENABLE_WARP_MODE_FR, "Activer le Mode Turbo"},
...
/* fr */ {IDCLS_SPECIFY_C64_MIDI_TYPE_FR, "Type d'interface MIDI (0:Séquentielle, 1:Passport, 2:DATEL, 3:Namesoft, 4:Maplin)"},
...
#ifdef HAS_TRANSLATION
/* da */ {IDCLS_ENABLE_SFX_SE_DA, "Aktivér SFX sound Expander cartridget"},
...
#ifdef HAS_TRANSLATION
/* da */ {IDCLS_DISABLE_SFX_SE_DA, "Deaktivér SFX Sound Expander cartridge"},
...
/* fr */ {IDCLS_DISABLE_SFX_SE_FR, "Désactiver la cartouche SFX Sound Expander"},
...
/* fr */ {IDCLS_SET_YM_CHIP_TYPE_FR, "Régler le type de puce YM (3526  3812)"},
...
/* fr */ {IDCLS_DISABLE_EASYFLASH_JUMPER_FR, "Désactiver le jumper EasyFlash"},
...
/* fr */ {IDCLS_ENABLE_EASYFLASH_CRT_WRITING_FR, "Activer l'écriture pour les images EasyFlash .crt"},
...
/* fr */ {IDCLS_DISABLE_EASYFLASH_CRT_WRITING_FR, "Désactiver l'écriture pour les images EasyFlash .crt"},
...
/* pl */ {IDCLS_ENABLE_EASYFLASH_CRT_OPTIMIZE_PL, "W³±cz optymalizacjê zapisu do obrazu .crt EasyFlash"},
...
/* fr */ {IDCLS_DISABLE_EASYFLASH_CRT_OPTIMIZE_FR, "Désactiver l'écriture pour les images EasyFlash .crt"},
/* hu */ {IDCLS_DISABLE_EASYFLASH_CRT_OPTIMIZE_HU, "EasyFlash .crt képmásba írás tiltása"},
...
/* de */ {IDCLS_SHORTBUS_ETFE_BASE_DE, "Basis Adresse für Short Bus ETFE Erweiterung"},
...
/* nl */ {IDCLS_SHORTBUS_ETFE_BASE_NL, "Basisadres van de Short Bus ETFE uitbreiding"},
...
#ifdef HAS_TRANSLATION
/* da */ {IDCLS_ENABLE_DS12C887RTC_DA, "Aktivér DS12C887 RTC-cartridge"},
...
#ifdef HAS_TRANSLATION
/* da */ {IDCLS_DISABLE_DS12C887RTC_DA, "Deaktivér DS12C887 RTC-cartridge"},
...
/* fr */ {IDCLS_DISABLE_DS12C887RTC_FR, "Désactiver la cartouche DS12C887 RTC"},
...
/* fr */ {IDCLS_DS12C887RTC_BASE_FR, "Adresse de base de la cartouche RTC DS12C887"},
...
/* de */ {IDCLS_CLOCKPORT_DEVICE_DE, "Clockport Gerät"},
...
/* nl */ {IDCLS_CLOCKPORT_DEVICE_NL, "Clockport apparaat"},
...
/* de */ {IDCLS_P_HOSTNAME_DE, "<Hostname>"},
...
/* nl */ {IDCLS_P_HOSTNAME_NL, "<Hostnaam>"},
/* pl */ {IDCLS_P_HOSTNAME_PL, "<nazwa hosta>"},
...
/* de */ {IDCLS_SET_NETPLAY_SERVER_DE, "Netplay Server Name setzen"},
...
/* nl */ {IDCLS_SET_NETPLAY_SERVER_NL, "Stel de netplay server hostnaam in"},
/* pl */ {IDCLS_SET_NETPLAY_SERVER_PL, "Wprowad¼ nazwê serwera gry sieciowej"},
...
/* de */ {IDCLS_SET_NETPLAY_BIND_ADDRESS_DE, "Netplay Bindadresse setzen"},
...
/* nl */ {IDCLS_SET_NETPLAY_BIND_ADDRESS_NL, "Stel het netplay binding adres in"},
/* pl */ {IDCLS_SET_NETPLAY_BIND_ADDRESS_PL, "Wprowad¼ adres gry sieciowej"},
...
/* de */ {IDCLS_SET_NETPLAY_PORT_DE, "Netplay TCP Port setzen (0..65535)"},
...
/* nl */ {IDCLS_SET_NETPLAY_PORT_NL, "Stel de netplay poort in (0..65535)"},
/* pl */ {IDCLS_SET_NETPLAY_PORT_PL, "Wybierz port TCP gry sieciowej (0..65535)"},
...
/* de */ {IDCLS_SET_NETPLAY_CONTROL_DE, "Netplay Steuerelemente (Tastatur, Joystick 1, Joystick 2, Geräte und\nResourcen), für jedes Element (0: Kein, 1: Server, 2: Client, 3: Beide)"},
...
/* nl */ {IDCLS_SET_NETPLAY_CONTROL_NL, "Stel de netplay besturingsonderdelen in (toetsenbord, joystick1, joystick2, apparaten en bronnen), elk onderdeel heeft een waarde (0: Geen, 1: Server, 2: Client, 3: Beide)"},
/* pl */ {IDCLS_SET_NETPLAY_CONTROL_PL, "Ustaw elementy kontrolne gry sieciowej (klawiatura, jostick1, joystick2, urz±dzenia i zasoby), ka¿dy element przyjmuje warto¶æ (0: Brak, 1: Serwer, 2: Klient, 3: Serwer+Klient)"},

...
static const cmdline_option_t cmdline_options[] = {
    { "-tapecart", SET_RESOURCE, 0,
      ...
      IDCLS_UNUSED, IDCLS_ENABLE_TAPECART,
      NULL, NULL },
    { "+tapecart", SET_RESOURCE, 0,

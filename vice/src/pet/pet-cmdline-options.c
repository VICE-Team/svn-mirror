...
static const cmdline_option_t cmdline_options[] = {
    ...
    { "-editor", SET_RESOURCE, 1,
      ...
      USE_PARAM_STRING, USE_DESCRIPTION_ID,
      IDGS_UNUSED, IDCLS_SPECIFY_EDITOR_ROM_NAME,
      "<Name>", NULL },
    ...
    { "-rom9", SET_RESOURCE, 1,
      ...
      USE_PARAM_STRING, USE_DESCRIPTION_ID,
      IDGS_UNUSED, IDCLS_SPECIFY_4K_ROM_9XXX_NAME,
      "<Name>", NULL },
    { "-romA", SET_RESOURCE, 1,
      NULL, NULL, "RomModuleAName", NULL,
      USE_PARAM_STRING, USE_DESCRIPTION_ID,
      IDGS_UNUSED, IDCLS_SPECIFY_4K_ROM_AXXX_NAME,
      "<Name>", NULL },
    { "-romB", SET_RESOURCE, 1,
      NULL, NULL, "RomModuleBName", NULL,
      USE_PARAM_STRING, USE_DESCRIPTION_ID,
      IDGS_UNUSED, IDCLS_SPECIFY_4K_ROM_BXXX_NAME,
      "<Name>", NULL },

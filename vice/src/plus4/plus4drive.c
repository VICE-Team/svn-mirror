...
/** \brief  List of drive type names and ID's supported by Plus/4
 *
...
/** \brief  Get a list of (name, id) tuples for the drives handles by Plus/4
 *
 ...
 *
 * \note    'supported' in this context means the drives Plus/4 can support,

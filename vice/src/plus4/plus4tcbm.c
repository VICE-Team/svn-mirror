...
{
    if (diskunit_context[0]->drives[0]->enable
        && diskunit_context[0]->drives[0]->type == DRIVE_TYPE_1551) {
...
{
    if (diskunit_context[1]->drives[0]->enable
        && diskunit_context[1]->drives[0]->type == DRIVE_TYPE_1551) {

...
#define VICII_PAL_DEBUG_LAST_DISPLAYED_LINE          (VICII_PAL_SCREEN_HEIGHT - 1)
...
#define VICII_NTSC_DEBUG_LAST_DISPLAYED_LINE         (VICII_NTSC_SCREEN_HEIGHT - 1)
...
#define VICII_NTSCOLD_DEBUG_LAST_DISPLAYED_LINE      (VICII_NTSCOLD_SCREEN_HEIGHT - 1)
...
#define VICII_PALN_DEBUG_LAST_DISPLAYED_LINE         (VICII_PALN_SCREEN_HEIGHT - 1)

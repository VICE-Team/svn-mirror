...
static const cmdline_option_t cmdline_options[] = {
    { "-fs8", CALL_FUNCTION, 1,
      ...
      IDGS_UNUSED, IDCLS_USE_AS_DIRECTORY_FSDEVICE_8,
      "<Name>", NULL },
    { "-fs9", CALL_FUNCTION, 1,
      cmdline_fsdirectory, (void *)9, NULL, NULL,
      USE_PARAM_STRING, USE_DESCRIPTION_ID,
      IDGS_UNUSED, IDCLS_USE_AS_DIRECTORY_FSDEVICE_9,
      "<Name>", NULL },
    { "-fs10", CALL_FUNCTION, 1,
      cmdline_fsdirectory, (void *)10, NULL, NULL,
      USE_PARAM_STRING, USE_DESCRIPTION_ID,
      IDGS_UNUSED, IDCLS_USE_AS_DIRECTORY_FSDEVICE_10,
      "<Name>", NULL },
    { "-fs11", CALL_FUNCTION, 1,
      cmdline_fsdirectory, (void *)11, NULL, NULL,
      USE_PARAM_STRING, USE_DESCRIPTION_ID,
      IDGS_UNUSED, IDCLS_USE_AS_DIRECTORY_FSDEVICE_11,
      "<Name>", NULL },
